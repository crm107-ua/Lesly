 ...
 *   https://datatables.net/download/#dt/dt-1.10.12/af-2.1.2/cr-1.3.2/rr-1.1.2/sc-1.4.2
 *
 * Included libraries:
 *  DataTables 1.10.12, AutoFill 2.1.2, ColReorder 1.3.2, RowReorder 1.1.2, Scroller 1.4.2
 */
...
(function(h) {
    ...
    m.ext = v = {
        buttons: {},
        classes: {},
        builder: "dt/dt-1.10.12/af-2.1.2/cr-1.3.2/rr-1.1.2/sc-1.4.2",
        errMode: "alert",
        feature: [],
        search: [],
        ...
        _attach: function(b) {
            ...
            if (
                ...
                this.dom.offsetParent ||
                    (this.dom.offsetParent = e(b).offsetParent());
                if (!h.height || !h.width)
                    d.appendTo("body"),
            ...
            if ("focus" === d)
                ...
                e(c.table().body()).on("click" + a, "td, th", function() {
                    ...
                    e(i.body).on("click" + a, function(a) {
                        e(a.target)
                            .parents()
                            .filter(c.table().body()).length || b._detach();
                    });
            else
                e(c.table().body())
            ...
            var b = this.s.dt,
                ...
                c = e.map(d, function(a, c) {
                    return d.length < c - 1
                        ...
                        : (a +
                              a +
                              e(b.row(":last-child").node()).outerHeight()) /
                              2;
                });
            this.s.middles = c;
