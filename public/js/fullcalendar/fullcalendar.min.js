...
(function(t, e) {
    ...
    function o(n, r) {
                ...
                if (r == R) {
                    if (a) {
                        n.eventDataTransform &&
                            (a = t.map(a, n.eventDataTransform)),
                            e.eventDataTransform &&
                                (a = t.map(a, e.eventDataTransform));
        ...
        function v(t, e) {
            w(t),
                t.source ||
                    (e && (H.events.push(t), (t.source = H)), W.push(t)),
                k(W);
        }
        function h(e) {
            if (e) {
                ...
                for (var r = 0; F.length > r; r++)
                    t.isArray(F[r].events) &&
                        (F[r].events = t.grep(F[r].events, e, !0));
            } else {
                W = [];
                for (var r = 0; F.length > r; r++)
        ...
        function w(t) {
            ...
            (t._id = t._id || (t.id === e ? "_fc" + xe++ : t.id + "")),
                ...
                t.allDay === e &&
                    (t.allDay = X(r.allDayDefault, n.allDayDefault)),
                t.className
    ...
    function y(t) {
        ...
        if (e) {
            ...
            return (
                e[3] &&
                    ((n %= 12),
                    "p" == e[3].toLowerCase().charAt(0) && (n += 12)),
    ...
    function Z(e, n, r) {
        ...
        function h(t) {
            ...
            return (
                ...
                re &&
                    (a +=
                        "<div class='fc-day-number'>" + t.getDate() + "</div>"),
                (a +=
        ...
        function s(n, r) {
            ...
            for (a = 0; S > a; a++)
                (o = n[a]),
                    (b = o.element) &&
                        ((b[0].style.width =
                            Math.max(0, o.outerWidth - o.hsides) + "px"),
        ...
        if (t.forwardCoord === e)
            for (
                o.length
                    ...
                    : (t.forwardCoord = 1),
                    t.backwardCoord =
                        t.forwardCoord - (t.forwardCoord - r) / (n + 1),
                    a = 0;
                o.length > a;
                a++
            )
    ...
    function fe(n, r, a) {
        ...
        function i(t, e) {
            return r.trigger.apply(
                r,
                [t, e || _].concat(Array.prototype.slice.call(arguments, 2), [
                    _
                ])
            );
        }
        ...
        function R(t) {
            ...
            return (
                (t += $[e]), 7 * Math.floor(t / U) + Q[((t % U) + U) % U] - e
            );
        }
        function N(t) {
            var e = d(_.visStart);
        ...
        function A(t) {
            var e = _.visStart.getDay();
            return (
                (t += e), Math.floor(t / 7) * U + $[((t % 7) + 7) % 7] - $[e]
            );
        }
        function O(t) {
            var e = _.getColCnt(),
    ...
    function de() {
        ...
        function o(t) {
            for (
                var e = t.start, n = C(t), r = ee(e, n), a = 0;
                r.length > a;
                a++
            )
                r[a].event = t;
            ...
            return (
                this.each(function() {
                    ...
                    if (r && t.isFunction(r[n])) {
                        ...
                        a === e && (a = i),
                            "destroy" == n &&
                                t.removeData(this, "fullCalendar");
                    }
                }),
                a !== e ? a : this
            );
