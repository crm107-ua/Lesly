...
(function(Z, P) {
    "object" === typeof module && module.exports
        ? ((P["default"] = P), (module.exports = Z.document ? P(Z) : P))
    ...
    P(u, "parts/Utilities.js", [u["parts/Globals.js"]], function(c) {
            ...
            C = (function() {
                ...
                a.prototype.dSetter = function() {
                    ...
                    if (1 === e) l = this.toD;
                        ...
                        for (; d--; ) {
                            ...
                            l[d] =
                                isNaN(B) || "A" === b[d - 4] || "A" === b[d - 5]
                                    ? b[d]
                                    : e * parseFloat("" + (b[d] - B)) + B;
                        }
                    else l = b;
                ...
                a.prototype.update = function() {
                    ...
                    if (this[b + "Setter"]) this[b + "Setter"]();
                        ...
                        a.attr
                            ? a.element && a.attr(b, l, null, !0)
                            : (a.style[b] = l + this.unit);
                    e && e.call(a, l, this);
                };
                a.prototype.run = function(a, b, l) {
                    ...
                    a !== b || this.elem["forceAnimate:" + this.prop]
                ...
                a.prototype.step = function(a) {
                    ...
                    if (e.attr && !e.element) a = !1;
                        ...
                        (this.pos = l.easing((b - this.startTime) / B)),
                            (this.now =
                                this.start +
                ...
                a.prototype.initPath = function(a, b, l) {
                    function e(a) {
                        for (H = a.length; H--; ) {
                            var b = "M" === a[H] || "L" === a[H];
                    ...
                    function B(a, b) {
                        for (var l = (t - a.length) / A; 0 < l && l--; )
                            (I = a.slice().splice(a.length / U - A, A * U)),
                                (I[0] = b[t - A - l * A]),
                                p &&
                                    ((I[A - 6] = I[A - 2]),
                                    (I[A - 5] = I[A - 1])),
                                [].splice.apply(a, [a.length / U, 0].concat(I)),
                                O && l--;
                    }
                    b = b || "";
                    var f = a.startX,
                    ...
                    if (f && h) {
                        for (H = 0; H < f.length; H++)
                            if (f[H] === h[0]) {
                                ...
                                f[f.length - 1] === h[h.length - f.length + H]
                            ) {
                                z = f.length - H;
                                break;
                            }
                ...
                a.prototype.strokeSetter = function() {
                    this.elem.attr(
                        ...
                        c
                            .color(this.start)
                            .tweenTo(c.color(this.end), this.pos),
                        null,
                        !0
                    );
                };
        ...
        var k = (c.pInt = function(a, b) {
            ...
            x = (c.isArray = function(a) {
                ...
                return (
                    "[object Array]" === a || "[object Array Iterator]" === a
                );
            }),
            ...
            L = (c.isDOMElement = function(a) {
                return m(a) && "number" === typeof a.nodeType;
            }),
        ...
        var p = (c.css = function(a, l) {
            ...
            z = (c.createElement = function(a, l, e, d, B) {
                a = N.createElement(a);
                l && b(a, l);
                B && p(a, { padding: "0", border: "none", margin: "0" });
                e && p(a, e);
                d && d.appendChild(a);
                return a;
            }),
            ...
            w = (c.pad = function(a, b, l) {
                return (
                    Array(
                        (b || 2) + 1 - String(a).replace("-", "").length
                    ).join(l || "0") + a
                );
            }),
            G = (c.relativeLength = function(a, b, l) {
                return /%$/.test(a)
                    ? (b * parseFloat(a)) / 100 + (l || 0)
                    : parseFloat(a);
            }),
            ...
            S = (c.normalizeTickInterval = function(a, b, l, e, d) {
                ...
                return (B = R(B * l, -Math.round(Math.log(0.001) / Math.LN10)));
            }),
            ...
            X = (c.setAnimation = function(a, b) {
                b.renderer.globalAnimation = q(
                    a,
            ...
            V = (c.animObject = function(a) {
                return m(a) ? g(a) : { duration: a ? 500 : 0 };
            }),
            B = (c.timeUnits = {
                millisecond: 1,
                second: 1e3,
            ...
            U = (c.numberFormat = function(a, b, l, e) {
                ...
                if (-1 === b) b = Math.min(B, 20);
                    ...
                    var h = b + +f[1];
                    0 <= h
                        ? ((f[0] = (+f[0]).toExponential(h).split("e")[0]),
                          (b = h))
                        : ((f[0] = f[0].split(".")[0] || 0),
                          (a =
                              20 > b
                                  ? (f[0] * Math.pow(10, f[1])).toFixed(b)
                                  : 0),
                          (f[1] = 0));
                }
                var p = (
                    Math.abs(f[1] ? f[0] : a) +
                    Math.pow(10, -Math.max(b, B) - 1)
                ).toFixed(b);
                B = String(k(p));
        ...
        var aa = (c.getStyle = function(a, b, l) {
                if ("width" === b)
                    return (
                        (b = Math.min(a.offsetWidth, a.scrollWidth)),
                        (l =
                            a.getBoundingClientRect &&
                            a.getBoundingClientRect().width),
                        l < b && l >= b - 1 && (b = Math.floor(l)),
                        Math.max(
                            0,
                            b -
                                c.getStyle(a, "padding-left") -
                                c.getStyle(a, "padding-right")
                        )
                    );
                if ("height" === b)
                    return Math.max(
                        ...
                        Math.min(a.offsetHeight, a.scrollHeight) -
                            c.getStyle(a, "padding-top") -
                            c.getStyle(a, "padding-bottom")
                    );
                D.getComputedStyle || F(27, !0);
                if ((a = D.getComputedStyle(a, void 0)))
                    (a = a.getPropertyValue(b)),
                        q(l, "opacity" !== b) && (a = k(a));
                return a;
            }),
            ...
            O = (c.find = Array.prototype.find
                ...
                : function(a, b) {
                      var l,
                          e = a.length;
                      for (l = 0; l < e; l++) if (b(a[l], l)) return a[l];
                  });
        c.keys = Object.keys;
        var T = (c.offset = function(a) {
                ...
                return {
                    top:
                        a.top +
                        (D.pageYOffset || b.scrollTop) -
                        (b.clientTop || 0),
                    left:
                        a.left +
                        (D.pageXOffset || b.scrollLeft) -
                        (b.clientLeft || 0)
                };
            }),
            ca = (c.stop = function(a, b) {
                for (var l = c.timers.length; l--; )
                    c.timers[l].elem !== a ||
                        (b && b !== c.timers[l].prop) ||
                        (c.timers[l].stopped = !0);
            }),
            ba = (c.objectEach = function(a, b, l) {
                for (var e in a)
                    Object.hasOwnProperty.call(a, e) &&
                        b.call(l || a[e], a[e], e, a);
            });
        ba(
            {
                map: "map",
            ...
            function(a, b) {
                c[b] = function(b) {
                    return Array.prototype[a].apply(
                        b,
        ...
        var fa = (c.addEvent = function(a, b, l, e) {
                ...
                var B =
                    "function" === typeof a && a.prototype
                        ? (a.prototype.protoEvents =
                              a.prototype.protoEvents || {})
                        : (a.hcEvents = a.hcEvents || {});
                c.Point &&
                    a instanceof c.Point &&
                    a.series &&
                    a.series.chart &&
            ...
            da = (c.removeEvent = function(a, b, l) {
                function e(b, l) {
                    var e =
                        a.removeEventListener || c.removeEventListenerPolyfill;
                    e && e.call(a, b, l, !1);
                }
                function d(l) {
                    var d;
                                ...
                                !1 ===
                                    (b[d]
                                        ? l[f]
                                            ...
                                            : b[d++]
                                        : l[f++]
                                    ).fn.call(a, e) && e.preventDefault();
                        })(
                            a.protoEvents && a.protoEvents[l],
                            a.hcEvents && a.hcEvents[l]
                        );
            ...
            ia = (c.animate = function(a, b, l) {
                ...
                if (!m(l)) {
                    var h = arguments;
                    l = { duration: h[2], easing: h[3], complete: h[4] };
                }
                M(l.duration) || (l.duration = 400);
                l.easing =
                ...
                ba(b, function(h, p) {
                    ...
                    B = null;
                    "d" === p
                        ? ((f.paths = f.initPath(a, a.d, b.d)),
                          (f.toD = b.d),
                          (e = 0),
                          (B = 1))
                        : a.attr
                        ? (e = a.attr(p))
                        : ((e = parseFloat(aa(a, p)) || 0),
                          "opacity" !== p && (d = "px"));
                    B || (B = h);
        ...
        D.jQuery &&
            (D.jQuery.fn.highcharts = function() {
                ...
                if (this[0])
                    return a[0]
                        ? (new c[r(a[0]) ? a.shift() : "Chart"](
                              this[0],
                              a[0],
                              a[1]
                          ),
                          this)
                        : v[E(this[0], "data-highcharts-chart")];
            });
        return {
            Fx: C,
            addEvent: fa,
            ...
            g = (function() {
                ...
                c.prototype.init = function(g) {
                    ...
                    if (
                        ...
                        this.stops = g.stops.map(function(k) {
                            return new c(k[1]);
                        });
                    else {
                ...
                c.prototype.tweenTo = function(c, g) {
                    ...
                    v.length && q && q.length
                        ? ((c = 1 !== v[3] || 1 !== q[3]),
                          (g =
                              (c ? "rgba(" : "rgb(") +
                              Math.round(v[0] + (q[0] - v[0]) * (1 - g)) +
                              "," +
                              Math.round(v[1] + (q[1] - v[1]) * (1 - g)) +
                              "," +
                              Math.round(v[2] + (q[2] - v[2]) * (1 - g)) +
                              (c
                                  ? "," + (v[3] + (q[3] - v[3]) * (1 - g))
                                  : "") +
                              ")"))
    ...
    P(
        ...
        [u["parts/Globals.js"], u["parts/Color.js"], u["parts/Utilities.js"]],
        function(c, g, E) {
            var q = g.parse,
                y = E.addEvent,
                v = E.animate,
            ...
            m(V.prototype, {
                ...
                init: function(a, b) {
                    this.element =
                        "span" === b ? F(b) : Q.createElementNS(this.SVG_NS, b);
                    this.renderer = a;
                    c.fireEvent(this, "afterInit");
                },
                animate: function(a, b, l) {
                    var d = N(e(b, this.renderer.globalAnimation, !0));
                    e(Q.hidden, Q.msHidden, Q.webkitHidden, !1) &&
                        (d.duration = 0);
                    0 !== d.duration
                        ? (l && (d.complete = l), v(this, a, d))
                        : (this.attr(a, void 0, l),
                          h(
                              a,
                              function(a, b) {
                                  d.step &&
                                      d.step.call(this, a, { prop: b, pos: 1 });
                              },
                              this
                          ));
                    return this;
                ...
                applyTextOutline: function(a) {
                    ...
                    if ((l = a[0]) && "none" !== l && c.svg) {
                        ...
                        l = l.replace(/(^[\d\.]+)(.*?)$/g, function(a, b, l) {
                            return 2 * b + l;
                        });
                    ...
                    for (var b = a.length, l; b--; )
                        (l = a[b]),
                            "highcharts-text-outline" ===
                                ...
                                x(a, this.element.removeChild(l));
                },
                ...
                updateShadows: function(a, b, l) {
                    for (var e = this.shadows, d = e.length; d--; )
                        l.call(
                            e[d],
                            "height" === a
                                ? Math.max(b - (e[d].cutHeight || 0), 0)
                                : "d" === a
                                ? this.d
                                : b,
                            a,
                ...
                hasClass: function(a) {
                    return (
                        -1 !== (this.attr("class") || "").split(" ").indexOf(a)
                    );
                },
                    ...
                    if (B) {
                        ...
                        if (a)
                            if (null === a.width || "auto" === a.width)
                                ...
                                var A = (this.textWidth = b(a.width));
                        this.styles = a;
                ...
                align: function(b, l, d) {
                    ...
                    if (b) {
                        if (
                            ((this.alignOptions = b),
                            (this.alignByTranslate = l),
                            !d || a(d))
                        )
                            (this.alignTo = f = d || "renderer"),
                                x(B, this),
                                B.push(this),
                                (d = null);
                    } else
                ...
                getBBox: function(a, b) {
                    ...
                    var z = d.styledMode
                        ? f && V.prototype.getStyle.call(f, "font-size")
                        : h && h.fontSize;
                    if (k(p)) {
                        var w = p.toString();
                    ...
                    if (!l) {
                        ...
                        d.isSVG &&
                            ...
                            b &&
                                ((h = b * K),
                                (l.width =
                                    Math.abs(d * Math.sin(h)) +
                                    Math.abs(a * Math.cos(h))),
                                (l.height =
                                    Math.abs(d * Math.cos(h)) +
                                    Math.abs(a * Math.sin(h)))));
                        if (w && 0 < l.height) {
                        ...
                        for (f = 1; f <= p; f++) {
                            ...
                            l &&
                                (D(
                                    I,
                                    "height",
                                    Math.max(D(I, "height") - H, 0)
                                ),
                                (I.cutHeight = H));
                            b
                                ? b.element.appendChild(I)
                                : h.parentNode &&
                ...
                titleSetter: function(a) {
                    ...
                    b ||
                        ((b = Q.createElementNS(this.SVG_NS, "title")),
                ...
                setTextPath: function(a, b) {
                    ...
                    if (a && b && b.enabled) {
                        p && null === p.element.parentNode
                            ...
                            : p &&
                              this.removeTextOutline.call(
                                  p.parentGroup,
                                  [].slice.call(l.getElementsByTagName("tspan"))
                              );
                        this.options &&
                            this.options.padding &&
                            (I.dx = -this.options.padding);
                        p ||
                            ((this.textPathWrapper = p = this.renderer.createElement(
                                "textPath"
                            )),
                            (f = !0));
                        var B = p.element;
                        (b = a.element.getAttribute("id")) ||
                            a.element.setAttribute("id", (b = w()));
                        if (A)
                            for (
                                a = l.getElementsByTagName("tspan");
                                a.length;

                            )
                                a[0].setAttribute("y", 0),
                                    M(I.dx) && a[0].setAttribute("x", -I.dx),
                                    B.appendChild(a[0]);
                        f &&
                            p.add({
                        ...
                        k(I.dy) &&
                            (B.parentNode.setAttribute("dy", I.dy),
                            delete I.dy);
                        k(I.dx) &&
                            (B.parentNode.setAttribute("dx", I.dx),
                            delete I.dx);
                        h(I, function(a, b) {
                ...
                destroyTextPath: function(a, b) {
                    ...
                    if (l) {
                        if (
                            ...
                            l.getElementsByTagName("textPath").length)
                        ) {
                            for (
                                a = this.textPathWrapper.element.childNodes;
                                a.length;
                ...
                fillSetter: function(a, b, l) {
                    "string" === typeof a
                        ? l.setAttribute(b, a)
                        : a && this.complexColor(a, b, l);
                },
                visibilitySetter: function(a, b, l) {
                    "inherit" === a
                        ? l.removeAttribute(b)
                        : this[b] !== a && l.setAttribute(b, a);
                    this[b] = a;
                },
                zIndexSetter: function(a, l) {
                    ...
                    k(a)
                        ? (h.setAttribute("data-z-index", a),
                          (a = +a),
                          this[l] === a && (A = !1))
                        : k(this[l]) && h.removeAttribute("data-z-index");
                    this[l] = a;
                    if (A) {
                        ...
                        for (I = l.length - 1; 0 <= I && !p; I--) {
                            ...
                            if (d !== h)
                                if (0 > a && H && !e && !I)
                                    f.insertBefore(h, l[I]), (p = !0);
                                else if (b(A) <= a || (H && (!k(a) || 0 <= a)))
                                    f.insertBefore(h, l[I + 1] || null),
                                        (p = !0);
                        }
                        p ||
                            (f.insertBefore(h, l[e ? 3 : 0] || null), (p = !0));
                    }
                    return p;
                },
            ...
            V.prototype.translateXSetter = V.prototype.translateYSetter = V.prototype.rotationSetter = V.prototype.verticalAlignSetter = V.prototype.rotationOriginXSetter = V.prototype.rotationOriginYSetter = V.prototype.scaleXSetter = V.prototype.scaleYSetter = V.prototype.matrixSetter = function(
                a,
                b
            ) {
                this[b] = a;
            ...
            V.prototype[
                "stroke-widthSetter"
            ] = V.prototype.strokeSetter = function(a, b, l) {
                this[b] = a;
                this.stroke && this["stroke-width"]
                    ? (V.prototype.fillSetter.call(
                          this,
                          this.stroke,
                          "stroke",
                          l
            ...
            m(g.prototype, {
                ...
                init: function(a, b, e, d, f, h, p) {
                    ...
                    -1 === a.innerHTML.indexOf("xmlns") &&
                        D(d, "xmlns", this.SVG_NS);
                    this.isSVG = !0;
                    this.box = d;
                    this.boxWrapper = A;
                    this.alignedObjects = [];
                    this.url =
                        (S || l) && Q.getElementsByTagName("base").length
                            ? X.location.href
                                  .split("#")[0]
                                  .replace(/<[^>]*>/g, "")
                                  .replace(/([\('\)])/g, "\\$1")
                    ...
                    this.createElement("desc")
                        .add()
                        .element.appendChild(
                            Q.createTextNode("Created with Highcharts 8.0.4")
                        );
                    ...
                    S &&
                        ...
                        b(),
                        (this.unSubPixelFix = y(X, "resize", b)));
                },
                definition: function(a) {
                    function b(a, e) {
                        ...
                        z(a).forEach(function(a) {
                            ...
                            f.add(e || l.defs);
                            a.textContent &&
                                f.element.appendChild(
                                    Q.createTextNode(a.textContent)
                                );
                            b(a.children || [], f);
                            d = f;
                        });
                ...
                buildText: function(a) {
                    ...
                    var R = function(a) {
                            ...
                            d.styledMode ||
                                (e = /(px|em)$/.test(a && a.style.fontSize)
                                    ? a.style.fontSize
                                    : m || d.style.fontSize || 12);
                            return n
                                ? b(n)
                                : d.fontMetrics(
                                      e,
                                      a.getAttribute("style") ? a : l
                                  ).h;
                        },
                        K = function(a, b) {
                    ...
                    if (X !== a.textCache) {
                        ...
                        (-1 !== p.indexOf(" ") && (!G || g.test(p)))
                            ...
                            : l.appendChild(Q.createTextNode(K(p)));
                    }
                },
                ...
                button: function(a, b, l, e, f, h, p, I, H, z) {
                    ...
                    y(w.element, A ? "mouseout" : "mouseleave", function() {
                        3 !== B && w.setState(B);
                    });
                    ...
                    t || w.attr(f).css(m({ cursor: "default" }, n));
                ...
                arc: function(a, b, l, e, d, h) {
                    f(a)
                        ? ((e = a), (b = e.y), (l = e.r), (a = e.x))
                        : (e = { innerR: e, start: d, end: h });
                ...
                symbol: function(a, b, l, d, f, h) {
                    ...
                    if (z) {
                        ...
                        t.imgheight = e(R[n] && R[n].height, h && h.height);
                        var c = function() {
                ...
                symbols: {
                    circle: function(a, b, l, e) {
                        return this.arc(a + l / 2, b + e / 2, l / 2, e / 2, {
                            start: 0.5 * Math.PI,
                            end: 2.5 * Math.PI,
                            open: !1
                        });
                    ...
                    arc: function(a, b, l, d, f) {
                        ...
                        d = e(
                            f.open,
                            0.001 > Math.abs(f.end - f.start - 2 * Math.PI)
                        );
                        var H = Math.cos(h),
                            z = Math.sin(h),
                            w = Math.cos(I);
                        I = Math.sin(I);
                        h = e(f.longArc, 0.001 > f.end - h - Math.PI ? 0 : 1);
                        p = [
                            "M",
                            a + p * H,
                            b + A * z,
                ...
                text: function(a, b, l, e) {
                    ...
                    if (e && (this.allowHTML || !this.forExport))
                        return this.html(a, b, l);
                    d.x = Math.round(b || 0);
                    l && (d.y = Math.round(l));
                    k(a) && (d.text = a);
                    a = this.createElement("text").attr(d);
                    e ||
                        (a.xSetter = function(a, b, l) {
                ...
                label: function(a, b, l, e, f, h, A, I, H) {
                    ...
                    var q = function() {
                        ...
                        J =
                            O +
                            Math.min(
                                z.fontMetrics(a && a.fontSize, n).b,
                                G ? G.height : Infinity
                            );
                        Q &&
                            (c ||
                                ((t.box = c =
                                    z.symbols[e] || x ? z.symbol(e) : z.rect()),
                                c.addClass(
                                    ("button" === H
                                        ? ""
                                ...
                                (b.x = a),
                                (b.y = (I ? -J : 0) + a)),
                            (b.width = Math.round(t.width)),
                            (b.height = Math.round(t.height)),
                            c.attr(m(b, X)),
                            (X = {}));
                    };
                    var v = function() {
                        ...
                        k(R) &&
                            G &&
                            ("center" === g || "right" === g) &&
                            (a += { center: 0.5, right: 1 }[g] * (R - G.width));
                        if (a !== n.x || b !== n.y)
                            n.attr("x", a),
                                n.hasBoxWidthChanged &&
                                    ((G = n.getBBox(!0)), q()),
                                "undefined" !== typeof b && n.attr("y", b);
                        n.x = a;
                        n.y = b;
                    };
                    var U = function(a, b) {
                    ...
                    t.onAdd = function() {
                        n.add(t);
                        t.attr({ text: a || 0 === a ? a : "", x: b, y: l });
                        c && k(f) && t.attr({ anchorX: f, anchorY: h });
                    };
                    ...
                    t.alignSetter = function(a) {
                        ...
                        a !== L && ((L = a), G && t.attr({ x: B }));
                    };
                    t.textSetter = function(a) {
                        "undefined" !== typeof a && n.attr({ text: a });
                        q();
                        v();
                    };
                    ...
                    w
                        ...
                        : (t.strokeSetter = t.fillSetter = t.rSetter = function(
                              a,
                              b
                          ) {
                              "r" !== b &&
        ...
        function(c, g) {
            ...
            N(x.prototype, {
                ...
                htmlUpdateTransform: function() {
                    if (this.added) {
                        var c = this.renderer,
                            ...
                            e = { left: 0, center: 0.5, right: 1 }[h],
                            b = this.styles,
                            p = b && b.whiteSpace;
                        y(n, { marginLeft: k, marginTop: f });
                        !c.styledMode &&
                            this.shadows &&
                            this.shadows.forEach(function(a) {
                                y(a, { marginLeft: k + 1, marginTop: f + 1 });
                            });
                        this.inverted &&
                        ...
                        if ("SPAN" === n.tagName) {
                            ...
                            t !== this.cTT &&
                                ((p = c.fontMetrics(n.style.fontSize, n).b),
                                !v(b) ||
                                    (b === (this.oldRotation || 0) &&
                                        h === this.oldAlign) ||
                                    this.setSpanRotation(b, e, p),
                                this.getSpanCorrection(
                                    (!v(b) && this.textPxLength) ||
                                        n.offsetWidth,
                                    p,
                                    e,
                                    b,
                ...
                setSpanRotation: function(c, n, k) {
                    ...
                    f[a + (C ? "Origin" : "-origin")] = f.transformOrigin =
                        100 * n + "% " + k + "px";
                    y(this.element, f);
                },
            ...
            N(g.prototype, {
                getTransformKey: function() {
                    return k && !/Edge/.test(m.navigator.userAgent)
                        ? "-ms-transform"
                        : r
                        ? "-webkit-transform"
                        : C
            ...
            g = (function() {
                ...
                m.prototype.addLabel = function() {
                    ...
                    if (n.isDatetimeAxis && b) {
                        var r = f.time.resolveDTLFormat(
                            m.dateTimeLabelFormats[
                                (!m.grid && b.higherRanks[h]) || b.unitName
                            ]
                        );
                        var g = r.main;
                    }
                        ...
                        c.shortenLabel = function() {
                            for (w = 0; w < G.length; w++)
                                if (
                                    ...
                                    t.getBBox().width <
                                        n.getSlotWidth(c) - 2 * k(e.padding, 5))
                                )
                                    return;
                            t.attr({ text: "" });
                        };
                    ...
                    y(t) || c.movedLabel
                        ...
                        : ((c.label = t = c.createLabel({ x: 0, y: 0 }, m, e)),
                          (c.rotation = 0));
                };
                m.prototype.createLabel = function(c, n, k) {
                    ...
                    if (
                        (c =
                            y(n) && k.enabled
                                ? a.renderer
                                      .text(n, c.x, c.y, k.useHTML)
                                      .add(f.labelGroup)
                                : null)
                    )
                        a.styledMode || c.css(F(k.style)),
                ...
                m.prototype.getPosition = function(c, n, k, f) {
                    ...
                    c = {
                        x: c
                            ? q(a.translate(n + k, null, null, f) + a.transB)
                            : a.left +
                              a.offset +
                              (a.opposite
                                  ? ((f && d.oldChartWidth) || d.chartWidth) -
                                    a.right -
                                    a.left
                                  : 0),
                        y: c
                            ? h -
                              a.bottom +
                              a.offset -
                              (a.opposite ? a.height : 0)
                            : q(
                                  h -
                                      a.translate(n + k, null, null, f) -
                                      a.transB
                              )
                    };
                    c.y = E(c.y, -1e5, 1e5);
                    r(this, "afterGetPosition", { pos: c });
                    return c;
                };
                m.prototype.getLabelPosition = function(
                    c,
                    n,
                    k,
                    f,
                    ...
                    y(G) ||
                        (G =
                            0 === b.side
                                ...
                                : 2 === b.side
                                ? w.y + 8
                                : Math.cos(k.rotation * x) *
                                  (w.y - k.getBBox(!1, 0).height / 2));
                ...
                m.prototype.handleOverflow = function(c) {
                    ...
                    d = k(
                        n.labelRight,
                        Math.max(n.isRadial ? 0 : n.pos + n.len, a - d[1])
                    );
                    var e = this.label,
                        b = this.rotation,
                        ...
                        r,
                        g = {};
                    if (b || "justify" !== k(m.overflow, "justify"))
                        0 > b && f - p * z < h
                            ? (r = Math.round(f / Math.cos(b * x) - h))
                            : 0 < b &&
                              f + p * z > d &&
                        ...
                        w < t &&
                            "center" === n.labelAlign &&
                            (c.x += G * (t - w - p * (t - Math.min(z, w)))),
                        z > w || (n.autoRotation && (e.styles || {}).width))
                    )
                        r = w;
                    r &&
                        (this.shortenLabel
                            ? this.shortenLabel()
                            : ((g.width = Math.floor(r)),
                ...
                m.prototype.moveLabel = function(c, n) {
                    var k = this,
                        ...
                        e = d.chart.inverted;
                    f && f.textStr === c
                        ? ((k.movedLabel = f), (a = !0), delete k.label)
                        : C(d.ticks, function(b) {
                              a ||
                                  b.isNew ||
                                  b === k ||
                                  !b.label ||
                                  b.label.textStr !== c ||
                                  ((k.movedLabel = b.label),
                                  (a = !0),
                                  (b.labelPos = k.movedLabel.xy),
                                  delete b.label);
                          });
                    if (!a && (k.labelPos || f)) {
                        ...
                        k.movedLabel = k.createLabel({ x: f, y: d }, c, n);
                    ...
                    b &&
                        ...
                        z &&
                            ((this.mark = p = d
                                ...
                                .add(f.axisGroup)),
                            f.chart.styledMode ||
                                p.attr({ stroke: a, "stroke-width": w })),
                        p[z ? "attr" : "animate"]({
                            d: this.getMarkPath(
                                t,
                                c,
                ...
                m.prototype.renderLabel = function(c, n, m, f) {
                    ...
                    e &&
                        ...
                        (this.isFirst &&
                            !this.isLast &&
                            !k(h.showFirstLabel, 1)) ||
                        (this.isLast && !this.isFirst && !k(h.showLastLabel, 1))
                            ? (z = !1)
                            : !d ||
                              b.step ||
                              b.rotation ||
                        ...
                        z && D(c.y)
                            ? ((c.opacity = m),
                              e[this.isNewLabel ? "attr" : "animate"](c),
                              (this.isNewLabel = !1))
            ...
            g = (function() {
                ...
                m.prototype.makeTime = function(k, n, m, f, a, d) {
                    if (this.useUTC) {
                        ...
                        e !== b
                            ? (h += b - e)
                            : e - 36e5 !== this.getTimezoneOffset(h - 36e5) ||
                              c.isSafari ||
                              (h -= 36e5);
                    } else
                        h = new this.Date(
                ...
                m.prototype.timezoneOffsetFunction = function() {
                    ...
                    if (!this.useUTC)
                        return function(f) {
                            return (
                                6e4 * new Date(f.toString()).getTimezoneOffset()
                            );
                        };
                    if (n.timezone) {
                        if (k)
                    ...
                    return this.useUTC && n.getTimezoneOffset
                        ? function(f) {
                              return 6e4 * n.getTimezoneOffset(f.valueOf());
                          }
                        : function() {
                ...
                m.prototype.dateFormat = function(k, n, m) {
                    ...
                    D(f, function(b, e) {
                        for (; -1 !== k.indexOf("%" + e); )
                            k = k.replace(
                                "%" + e,
                                "function" === typeof b ? b.call(a, n) : b
                            );
                    });
                ...
                m.prototype.resolveDTLFormat = function(c) {
                    return v(c, !0)
                        ? c
                        : ((c = k(c)), { main: c[0], from: c[1], to: c[2] });
                };
                m.prototype.getTimeTicks = function(c, n, k, f) {
                    ...
                    if (E(n)) {
                        a.set(
                            ...
                            b >= r.second
                                ? 0
                                : p * Math.floor(a.get("Milliseconds", e) / p)
                        );
                        b >= r.second &&
                            a.set(
                                "Seconds",
                                ...
                                b >= r.minute
                                    ? 0
                                    : p * Math.floor(a.get("Seconds", e) / p)
                            );
                        b >= r.minute &&
                            a.set(
                                "Minutes",
                                ...
                                b >= r.hour
                                    ? 0
                                    : p * Math.floor(a.get("Minutes", e) / p)
                            );
                        b >= r.hour &&
                            a.set(
                                "Hours",
                    ...
                    d.info = y(c, { higherRanks: h, totalRange: b * p });
                    return d;
                };
                m.defaultOptions = {
                    Date: void 0,
        ...
        function(c, g, E, q) {
            ...
            c.defaultOptions = {
                ...
                lang: {
                    ...
                    shortMonths: "Enero Febrero Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre".split(
                        " "
                    ),
                    weekdays: "Domingo Lunes Martes Miercoles Jueves Viernes Sábado".split(
                        " "
                    ),
                    decimalPoint: ".",
            ...
            c.setOptions = function(g) {
                ...
                (g.time || g.global) &&
                    c.time.update(
                        y(
                            c.defaultOptions.global,
                            c.defaultOptions.time,
                            g.global,
                            g.time
                        )
                    );
            ...
            L(g.prototype, {
                ...
                init: function(a, b) {
                    ...
                    var f = this.options,
                        h = f.type;
                    e.labelFormatter =
                        f.labels.formatter || e.defaultLabelFormatter;
                    e.userOptions = b;
                    e.minPixelPadding = 0;
                    ...
                    e.crosshair = t(
                        f.crosshair,
                        K(a.options.tooltip.crosshairs)[l ? 0 : 1],
                        !1
                    );
                    b = e.options.events;
                    -1 === a.axes.indexOf(e) &&
                        (l
                            ? a.axes.splice(a.xAxis.length, 0, e)
                            : a.axes.push(e),
                        a[e.coll].push(e));
                    e.series = e.series || [];
                    a.inverted &&
                    ...
                    e.isLog &&
                        ((e.val2lin = e.log2lin), (e.lin2val = e.lin2log));
                    n(this, "afterInit");
                },
                setOptions: function(a) {
                    ...
                    n(this, "afterSetOptions", { userOptions: a });
                },
                ...
                translate: function(a, b, e, d, f, p) {
                    ...
                    f =
                        (l.isOrdinal || l.isBroken || (l.isLog && f)) &&
                        l.lin2val;
                    H || (H = l.transA);
                    e && ((A *= -1), (c = l.len));
                ...
                getMinorTickPositions: function() {
                    ...
                    if (c && c / d < a.len / 3)
                        if (a.isLog)
                            this.paddedTicks.forEach(function(b, l, e) {
                                l &&
                                    f.push.apply(
                                        f,
                ...
                setAxisTranslation: function(a) {
                    ...
                    if (w || A || f) {
                        ...
                        c
                            ? ((h = c.minPointOffset),
                              (p = c.pointRangePadding))
                            : b.series.forEach(function(a) {
                                  var l = A
                                          ? 1
                                          : w
                                          ? t(a.options.pointRange, k, 0)
                                          : b.axisPointRange || 0,
                    ...
                    a && (b.oldTransA = z);
                    b.translationSlope = b.transA = z =
                        b.staticScale || b.len / (d + p || 1);
                ...
                setTickInterval: function(a) {
                    ...
                    if (w) {
                        ...
                        d.type !== b.linkedParent.options.type && m(11, 1, e);
                    } else {
                        if (!x && r(T))
                    ...
                    c &&
                        (b.positiveValuesOnly &&
                            !a &&
                            0 >= Math.min(b.min, t(b.dataMin, b.min)) &&
                            m(10, 1, e),
                        (b.min = k(b.log2lin(b.min), 16)),
                        (b.max = k(b.log2lin(b.max), 16)));
                    b.range &&
                        r(b.max) &&
                        ((b.userMin = b.min = q = Math.max(
                            b.dataMin,
                            b.minFromRange()
                        )),
                        (b.userMax = S = b.max),
                    ...
                    b.adjustForMinRange();
                    !(O || b.axisPointRange || b.usePercentage || w) &&
                        r(b.min) &&
                        r(b.max) &&
                        (e = b.max - b.min) &&
                        (!r(q) && g && (b.min -= e * g),
                    ...
                    h(b.userMin) ||
                        (h(d.softMin) &&
                            d.softMin < b.min &&
                            (b.min = q = d.softMin),
                        h(d.floor) && (b.min = Math.max(b.min, d.floor)));
                    h(b.userMax) ||
                        (h(d.softMax) &&
                            d.softMax > b.max &&
                            (b.max = S = d.softMax),
                        h(d.ceiling) && (b.max = Math.min(b.max, d.ceiling)));
                    x &&
                        r(b.dataMin) &&
                        ((T = T || 0),
                        !r(q) && b.min < T && b.dataMin >= T
                            ? (b.min = b.options.minRange
                                  ? Math.min(T, b.max - b.minRange)
                                  : T)
                            : !r(S) &&
                              b.max > T &&
                              b.dataMax <= T &&
                              (b.max = b.options.minRange
                                  ? Math.max(T, b.min + b.minRange)
                                  : T));
                    b.tickInterval =
                        b.min === b.max ||
                ...
                adjustTickAmount: function() {
                    ...
                    if (this.hasData()) {
                        if (h < d) {
                            for (c = this.min; e.length < d; )
                                e.length % 2 || c === p
                                    ? e.push(k(e[e.length - 1] + b))
                                    : e.unshift(k(e[0] - b));
                            this.transA *= (h - 1) / (d - 1);
                            this.min = a.startOnTick
                                ? e[0]
                ...
                setAxisSize: function() {
                    var a = this.chart,
                        ...
                        f = (this.width = Math.round(
                            w(
                                t(b.width, a.plotWidth - e[3] + e[1]),
                                a.plotWidth
                            )
                        )),
                        h = (this.height = Math.round(
                            w(
                                t(b.height, a.plotHeight - e[0] + e[2]),
                                a.plotHeight
                            )
                        )),
                        p = (this.top = Math.round(
                            w(
                                t(b.top, a.plotTop + e[0]),
                                a.plotHeight,
                                a.plotTop
                            )
                        ));
                    b = this.left = Math.round(
                        w(t(b.left, a.plotLeft + e[3]), a.plotWidth, a.plotLeft)
                    );
                ...
                tickSize: function(a) {
                    var b = this.options,
                        ...
                        d = t(
                            b[a + "Width"],
                            "tick" === a && this.isXAxis && !this.categories
                                ? 1
                                : 0
                        );
                    if (d && e) {
                ...
                renderUnsquish: function() {
                    ...
                    d.forEach(function(a) {
                        ...
                        a &&
                            a.label &&
                            a.label.textPxLength > m &&
                            (m = a.label.textPxLength);
                    });
                    ...
                    if (this.autoRotation)
                        ...
                        if (!k) {
                            ...
                            for (t = d.length; !c && t--; ) {
                                ...
                                if ((K = f[K].label))
                                    K.styles &&
                                    "ellipsis" === K.styles.textOverflow
                                        ? K.css({ textOverflow: "clip" })
                                        : K.textPxLength > z &&
                                          K.css({ width: z + "px" }),
                                        K.getBBox().height >
                                            this.len / d.length - (n.h - n.f) &&
                                            (K.specificTextOverflow =
                                                "ellipsis");
                            }
                        }
                    }
                    w.rotation &&
                        ((G =
                            m > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : m),
                        k || (r = "ellipsis"));
                    if (
                        (this.labelAlign =
                ...
                addTitle: function(a) {
                    ...
                    this.axisTitle ||
                        ...
                        c || this.axisTitle.css(b(h.style)),
                ...
                getOffset: function() {
                    ...
                    if (
                        ...
                        O.text &&
                        !1 !== O.enabled &&
                        (a.addTitle(k), k && !1 !== O.reserveSpace)
                    ) {
                        a.titleOffset = m = a.axisTitle.getBBox()[
                            p ? "height" : "width"
                        ];
                        var v = O.offset;
                    ...
                    a.renderLine();
                    a.offset =
                        x * t(d.offset, J[c] ? J[c] + (d.margin || 0) : 0);
                    ...
                    g &&
                        (G =
                            G -
                            e +
                            x * (p ? t(K.y, a.tickRotCorr.y + 8 * x) : K.x));
                    ...
                    J[c] = Math.max(
                        J[c],
                        a.axisTitleMargin + m + x * a.offset,
                        G,
                        f && f.length && p ? p[0] + x * a.offset : 0
                    );
                    d = d.offset
                        ? 0
                ...
                getTitlePosition: function() {
                    ...
                    n(this, "afterGetTitlePosition", { titlePosition: a });
                    return a;
                },
                ...
                renderTick: function(a, b) {
                    ...
                    if (!e || (a >= this.min && a <= this.max))
                        d[a] || (d[a] = new E(this, a)),
                            l && d[a].isNew && d[a].render(b, !0, -1),
                            d[a].render(b);
                },
                render: function() {
                    var a = this,
                    ...
                    if (a.hasData() || f)
                        a.minorTickInterval &&
                            ...
                            p.length &&
                                ...
                                O &&
                                    (0 === a.min || a.single) &&
                                    (w[-1] || (w[-1] = new E(a, -1, null, !0)),
                                    w[-1].render(-1))),
                            r &&
                                p.forEach(function(e, l) {
                                    q =
                                        "undefined" !== typeof p[l + 1]
                                            ? p[l + 1] + O
                                            : a.max - O;
                                    0 === l % 2 &&
                                        e < a.max &&
                    ...
                    t &&
                        ...
                        h(e.y)
                            ? (t[t.isNew ? "attr" : "animate"](e),
                              (t.isNew = !1))
                            : (t.attr("y", -9999), (t.isNew = !0)));
                ...
                drawCrosshair: function(a, b) {
                    var e = this.crosshair,
                        ...
                        f = this.cross,
                        h = this.chart;
                    n(this, "drawCrosshair", { e: a, point: b });
                    a || (a = this.cross && this.cross.e);
                    if (this.crosshair && !1 !== (r(b) || !d)) {
                        d
                            ? r(b) &&
                              (l = t(
                                  "colorAxis" !== this.coll
                        ...
                        if (r(l)) {
                            var p = {
                                value:
                                    b &&
                                    (this.isXAxis ? b.x : t(b.stackY, b.y)),
                                translatedValue: l
                            };
                            h.polar &&
                                L(p, {
                    ...
                    n(this, "afterDrawCrosshair", { e: a, point: b });
                },
        ...
        function(c, g) {
            ...
            c.prototype.normalizeTimeTickInterval = function(c, g) {
                ...
                for (
                    ...
                    (C = g[1]),
                    v[k + 1] &&
                        c <= (F * C[C.length - 1] + y[v[k + 1][0]]) / 2);
                    k++
                );
                F === y.year && c < 5 * F && (C = [1, 2, 5]);
                c = q(c / F, C, "year" === g[0] ? Math.max(E(c / F), 1) : 1);
                return { unitRange: F, count: c, unitName: g[0] };
            };
        }
    );
    P(
        ...
        function(c, g) {
            var E = g.getMagnitude,
                ...
                y = g.pick;
            c = c.Axis;
            c.prototype.getLogTickPositions = function(c, g, D, F) {
                var v = this.options,
                    k = this.len,
                    r = [];
                ...
                if (0.5 <= c)
                    (c = Math.round(c)),
                        (r = this.getLinearTickPositions(c, g, D));
                else if (0.08 <= c) {
                    k = Math.floor(g);
                    var x, m;
                    for (
                    ...
                    (g = this.lin2log(g)),
                        (D = this.lin2log(D)),
                        (c = F ? this.getMinorTickInterval() : v.tickInterval),
                        (c = y(
                            "auto" === c ? null : c,
                            this._minorAutoInterval,
                            ((v.tickPixelInterval / (F ? 5 : 1)) * (D - g)) /
                                ((F ? k / this.tickPositions.length : k) || 1)
                        )),
                        (c = q(c, null, E(c))),
                        (r = this.getLinearTickPositions(c, g, D).map(
                            this.log2lin
                        )),
                        F || (this._minorAutoInterval = c / 5);
    ...
    P(
        ...
        [u["parts/Globals.js"], u["parts/Axis.js"], u["parts/Utilities.js"]],
        function(c, g, E) {
            var q = E.arrayMax,
                y = E.arrayMin,
                v = E.defined,
                ...
                x = (function() {
                    ...
                    m.prototype.render = function() {
                        ...
                        q.zIndex = x;
                        l += "-" + x;
                        (K = n.plotLinesAndBandsGroups[l]) ||
                            (n.plotLinesAndBandsGroups[l] = K = A.g("plot-" + l)
                                .attr(q)
                                .add());
                        w &&
                            (m.svgElem = t = A.path()
                        ...
                        (w || !t.d) && G && G.length
                            ...
                            : t &&
                              (G
                                  ? (t.show(!0), t.animate({ d: G }))
                                  : t.d &&
                                    (t.hide(),
                                    d && (m.label = d = d.destroy())));
                        a &&
                        ...
                        !G.isFlat
                            ? ((a = C(
                              ...
                              this.renderLabel(a, G, p, x))
                            : d && d.hide();
                        return m;
                    };
                    m.prototype.renderLabel = function(c, n, k, f) {
                        var a = this.label,
            ...
            F(g.prototype, {
                getPlotBandPath: function(c, k) {
                    var n = this.getPlotLinePath({
                        ...
                        d = 1;
                    c =
                        (c < this.min && k < this.min) ||
                        (c > this.max && k > this.max);
                    if (m && n) {
                        if (c) {
                            var h = m.toString() === n.toString();
                            d = 0;
                        }
                        for (c = 0; c < m.length; c += 6)
                            a && n[c + 1] === m[c + 1]
                                ? ((n[c + 1] += d), (n[c + 4] += d))
                                : a ||
                                  n[c + 2] !== m[c + 2] ||
                ...
                M = (function() {
                    ...
                    f.prototype.bodyFormatter = function(a) {
                        return a.map(function(a) {
                            ...
                            return (
                                d[
                                    (a.point.formatPrefix || "point") +
                                        "Formatter"
                                ] || a.point.tooltipFormatter
                            ).call(
                                a.point,
                                d[
                                    (a.point.formatPrefix || "point") + "Format"
                                ] || ""
                            );
                        });
                    };
                    ...
                    f.prototype.getAnchor = function(a, d) {
                        ...
                        this.followPointer && d
                            ? ("undefined" === typeof d.chartX &&
                                  (d = e.normalize(d)),
                              (a = [d.chartX - c, d.chartY - p]))
                            : a[0].tooltipPos
                            ? (a = a[0].tooltipPos)
                    ...
                    f.prototype.getLabel = function() {
                        var a,
                            ...
                            p =
                                "tooltip" +
                                (y(b.className) ? " " + b.className : ""),
                            z =
                                (null === (a = b.style) || void 0 === a
                                    ? void 0
                                    : a.pointerEvents) ||
                        ...
                        if (!this.label) {
                            this.outside &&
                                ((this.container = t = c.doc.createElement(
                                    "div"
                                )),
                    ...
                    f.prototype.getPosition = function(a, d, f) {
                        var e = this.chart,
                            ...
                            w = this.outside,
                            k = w
                                ? n.documentElement.clientWidth - 2 * b
                                : e.chartWidth,
                            m = w
                                ? Math.max(
                                      n.body.scrollHeight,
                            ...
                            q =
                                !this.followPointer &&
                                r(f.ttBelow, !e.inverted === !!f.negative),
                    ...
                    f.prototype.refresh = function(a, d) {
                        ...
                        if (e.enabled) {
                            ...
                            !p || (b.series && b.series.noSharedTooltip)
                                ? (p = b.getLabelConfig())
                                : (f.pointer.applyInactiveState(b),
                            ...
                            f = t.call(p, this);
                            t = b.series;
                            this.distance = r(t.tooltipOptions.distance, 16);
                            !1 === f
                                ? this.hide()
                                : (this.split
                                      ? this.renderSplit(f, x(a))
                                      : ((a = this.getLabel()),
                                        (e.style.width && !w) ||
                                            a.css({
                                                width: this.chart.spacingBox
                                                    .width
                                            }),
                                        a.attr({
                    ...
                    f.prototype.renderSplit = function(a, d) {
                        function f(a, b, e, d, f) {
                            ...
                            e
                                ? ((b = M ? 0 : y),
                                  (a = E(a - d / 2, R.left, R.right - d)))
                                : ((b -= B),
                                  (a = f ? a - d - H : a + H),
                                  (a = E(a, f ? a : R.left, R.right)));
                            return { x: a, y: b };
                        }
                        var e = this,
                            b = e.chart,
                        ...
                        a = a.slice(0, d.length + 1).reduce(function(a, b, h) {
                            if (!1 !== b && "" !== b) {
                                ...
                                var O =
                                    "highcharts-color-" +
                                    r(h.colorIndex, G.colorIndex, "none");
                                k ||
                                    ((k = {
                                        padding: I.padding,
                                        r: I.borderRadius
                                    ...
                                    l ||
                                        ...
                                        (k["stroke-width"] = I.borderWidth)),
                                    (k = n
                                        .label(
                                            "",
                                            0,
                                            0,
                                            I[m ? "headerShape" : "shape"] ||
                                                "callout",
                                            void 0,
                                            void 0,
                                            I.useHTML
                        ...
                        e.outside &&
                            ...
                            b &&
                            ((p = v.getBBox()),
                            b.setSize(p.width + p.x, p.height + p.y, !1),
                            (k = k.getChartPosition()),
                            (a.style.left = k.left + "px"),
                            (a.style.top = k.top + "px"));
                    };
                    ...
                    f.prototype.tooltipFooterHeaderFormatter = function(a, d) {
                        ...
                        c.fireEvent(this, "headerFormatter", d, function(d) {
                            ...
                            e.chart.styledMode &&
                                (w = this.styledModeFormat(w));
                            d.text = D(w, { point: a, series: e }, this.chart);
                        });
                        return d.text;
                    };
        ...
        function(c, g, E, q) {
            ...
            g = (function() {
                ...
                h.prototype.destroy = function() {
                    var a = this;
                    "undefined" !== typeof a.unDocMouseMove &&
                        a.unDocMouseMove();
                    ...
                    if (!A || !A.touch)
                        if (
                            ...
                            b.hasCartesianSeries &&
                                ...
                                !q &&
                                !A &&
                                ((this.selectionMarker = A = b.renderer
                                    .rect(n, m, c ? 1 : r, k ? 1 : g, 0)
                                    .attr({
                ...
                h.prototype.drop = function(a) {
                    ...
                    if (this.selectionMarker) {
                        ...
                        if (this.hasDragged || d)
                            e.axes.forEach(function(e) {
                                ...
                                x &&
                                    k(e, "selection", f, function(a) {
                                        e.zoom(
                                            F(a, d ? { animation: !1 } : null)
                                        );
                                    });
                        r(e.index) &&
                    ...
                    e &&
                        r(e.index) &&
                        (N(e.container, { cursor: e._cursor }),
                    ...
                    t = t
                        ...
                        : d.filter(function(a) {
                              return w.filter
                                  ...
                                  : a.visible &&
                                        !(!h && a.directTouch) &&
                                        n(a.options.enableMouseTracking, !0) &&
                                        a.stickyTracking;
                          });
                    b =
                        (e = f || !c ? a : this.findNearestKDPoint(t, h, c)) &&
                        e.series;
                    e &&
                        (h && !b.noSharedTooltip
                            ? ((t = d.filter(function(a) {
                                  return w.filter
                                      ? w.filter(a)
                                      : a.visible &&
                                            !(!h && a.directTouch) &&
                ...
                h.prototype.init = function(a, b) {
                    ...
                    this.lastValidTouch = {};
                    E &&
                        ((a.tooltip = new E(a, b.tooltip)),
                        (this.followTouchMove = n(
                            b.tooltip.followTouchMove,
                            !0
                        )));
                    this.setDOMEvents();
                };
                ...
                h.prototype.onContainerClick = function(a) {
                    ...
                    b.cancelClick ||
                        (e && this.inClass(a.target, "highcharts-tracker")
                            ? (k(e.series, "click", F(a, { point: e })),
                              b.hoverPoint && e.firePointEvent("click", a))
                            : (F(a, this.getCoordinates(a)),
                              b.isInsidePlot(a.chartX - d, a.chartY - f) &&
                                  k(b, "click", a)));
                };
                ...
                h.prototype.onContainerMouseMove = function(e) {
                    ...
                    (D(c.hoverChartIndex) &&
                        a[c.hoverChartIndex] &&
                        a[c.hoverChartIndex].mouseIsDown) ||
                ...
                h.prototype.onDocumentTouchEnd = function(e) {
                    a[c.hoverChartIndex] &&
                        a[c.hoverChartIndex].pointer.drop(e);
                };
                ...
                h.prototype.pinch = function(a) {
                    ...
                    "touchstart" === a.type
                        ? ([].forEach.call(h, function(a, b) {
                              f[b] = { chartX: a.chartX, chartY: a.chartY };
                          }),
                          (k.x = [f[0].chartX, f[1] && f[1].chartX]),
                          (k.y = [f[0].chartY, f[1] && f[1].chartY]),
                          e.axes.forEach(function(a) {
                              if (a.zoomEnabled) {
                                  var b = e.bounds[a.horiz ? "h" : "v"],
                                      ...
                                      f = a.toPixels(
                                          Math.min(
                                              n(a.options.min, a.dataMin),
                                              a.dataMin
                                          )
                                      ),
                                      l = a.toPixels(
                                          Math.max(
                                              n(a.options.max, a.dataMax),
                                              a.dataMax
                                          )
                                      ),
                                      h = Math.max(f, l);
                          ...
                          (b.res = !0))
                        : b.followTouchMove && 1 === c
                        ? this.runPointActions(b.normalize(a))
                        : f.length &&
                          (r ||
                              (b.selectionMarker = r = F(
                                  { destroy: d, touch: !0 },
                                  e.plotBox
                              )),
                          b.pinchTranslate(f, h, g, r, A, k),
                          (b.hasPinched = m),
                          b.scaleGroups(g, A),
                ...
                h.prototype.pinchTranslate = function(a, b, d, f, h, c) {
                    this.zoomHor &&
                        this.pinchTranslateDirection(!0, a, b, d, f, h, c);
                    this.zoomVert &&
                        this.pinchTranslateDirection(!1, a, b, d, f, h, c);
                };
                h.prototype.pinchTranslateDirection = function(
                    a,
                    b,
                    d,
                    f,
                ...
                h.prototype.runPointActions = function(e, b) {
                    ...
                    m = this.getHoverData(
                        ...
                        d.series,
                        (!e || "touchmove" !== e.type) &&
                            (!!b || (m && m.directTouch && this.isDirectTouch)),
                        h,
                        e
                    );
                    k = m.hoverPoint;
                    ...
                    if (k && (k !== d.hoverPoint || (f && f.isHidden))) {
                        ...
                        b &&
                            ...
                            !f.isHidden &&
                            ((k = f.getAnchor([{}], e)),
                            f.updatePosition({ plotX: k[0], plotY: k[1] }));
                    this.unDocMouseMove ||
                ...
                h.prototype.scaleGroups = function(a, b) {
                    ...
                    e.series.forEach(function(f) {
                        ...
                        f.xAxis &&
                            ...
                            (f.group.attr(d),
                            f.markerGroup &&
                                (f.markerGroup.attr(d),
                                f.markerGroup.clip(b ? e.clipRect : null)),
                ...
                h.prototype.setDOMEvents = function() {
                    ...
                    this.unbindContainerMouseLeave = y(
                        b,
                        "mouseleave",
                        a.onContainerMouseLeave
                    );
                    c.unbindDocumentMouseUp ||
                        (c.unbindDocumentMouseUp = y(
                            d,
                            "mouseup",
                            a.onDocumentMouseUp
                        ));
    ...
    P(
        u,
        "parts/MSPointer.js",
        [u["parts/Globals.js"], u["parts/Pointer.js"], u["parts/Utilities.js"]],
        function(c, g, E) {
            function q() {
                var c = [];
                c.item = function(c) {
            ...
            return (function(c) {
                ...
                k.prototype.onContainerPointerMove = function(f) {
                    y(f, "onContainerTouchMove", "touchmove", function(a) {
                        m[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
                        m[a.pointerId].target ||
                            (m[a.pointerId].target = a.currentTarget);
                    });
                };
                ...
                d = (function() {
                    ...
                    a.prototype.positionItem = function(a) {
                        ...
                        if ((a = a.legendGroup) && a.element)
                            a[y(a.translateY) ? "animate" : "attr"]({
                                translateX: b
                                    ? f
                                    : this.legendWidth - f - 2 * e - 4,
                                translateY: d
                            });
                        h && ((h.x = f), (h.y = d));
                    };
                    ...
                    a.prototype.renderItem = function(a) {
                        ...
                        x ||
                            ...
                            b.styledMode || x.css(k(a.visible ? c : n)),
                            x
                                .attr({
                                    align: g ? "left" : "right",
                                    zIndex: 2
                            ...
                            l.drawLegendSymbol(this, a),
                            this.setItemEvents && this.setItemEvents(a, x, I));
                        H &&
                            !a.checkbox &&
                            this.createCheckboxForItem &&
                            this.createCheckboxForItem(a);
                        this.colorizeItem(a, a.visible);
                        (!b.styledMode && c.width) ||
                            x.css({
                                width:
                                    (e.itemWidth ||
                                        this.widthOption ||
                                        b.spacingBox.width) - m
                            });
                        this.setText(a);
                        b = x.getBBox();
                    ...
                    a.prototype.layoutItem = function(a) {
                        ...
                        e &&
                            ...
                            ((this.itemX = d),
                            this.lastLineHeight &&
                                (this.itemY += c + this.lastLineHeight + h),
                    ...
                    a.prototype.proximatePositions = function() {
                        ...
                        this.allItems.forEach(function(e) {
                            ...
                            if (e.yAxis && e.points) {
                                ...
                                var h = N(
                                    f ? e.points : e.points.slice(0).reverse(),
                                    function(a) {
                                        return C(a.plotY);
                                    }
                                );
                                ...
                                e.visible
                                    ? ((h = h ? h.plotY : e.yAxis.height),
                                      (h += c - 0.3 * f))
                                    : (h = c + e.yAxis.height);
                                b.push({ target: h, size: f, item: e });
                            }
                        }, this);
                        c.distribute(b, a.plotHeight);
                        b.forEach(function(b) {
                            b.item._legendItemPos[1] =
                                a.plotTop - a.spacing[0] + b.pos;
                        });
                    };
                    a.prototype.render = function() {
                        ...
                        var m = a.spacingBox.width - 2 * n - c.x;
                        -1 <
                            ["rm", "lm"].indexOf(
                    ...
                    a.prototype.handleOverflow = function(a) {
                        ...
                        a > h && !1 !== g.enabled
                            ? ((this.clipHeight = n = Math.max(
                              ...
                              m ||
                                  ((m = b.clipRect = e.clipRect(0, c, 9999, 0)),
                              ...
                              H ||
                                  ...
                                  d.styledMode || this.pager.css(g.style),
                                  this.pager.add(H),
                                  (this.down = e
                    ...
                    a.prototype.scroll = function(a, b) {
                        ...
                        0 < k &&
                            ...
                            (this.scrollOffset = -f[k - 1] + this.initialItemY),
                            ...
                            (b = c.animObject(
                                r(b, e.renderer.globalAnimation, !0)
                            )),
                            n(function() {
                                D(d, "afterScroll", { currentPage: k });
                            }, b.duration || 0));
                    };
                    return a;
                })();
            (/Trident\/7\.0/.test(a.navigator && a.navigator.userAgent) || M) &&
                g(d.prototype, "positionItem", function(a, d) {
                    var b = this,
                        e = function() {
    ...
    P(
        ...
        [
            u["parts/Globals.js"],
            u["parts/Legend.js"],
            u["parts/MSPointer.js"],
            u["parts/Pointer.js"],
            u["parts/Time.js"],
            u["parts/Utilities.js"]
        ],
        function(c, g, E, q, y, v) {
            var N = v.addEvent,
                D = v.animate,
                F = v.animObject,
                C = v.attr,
            ...
            M(Y.prototype, {
                ...
                initSeries: function(a) {
                    ...
                    var d = U[b];
                    d || n(17, !0, this, { missingModuleFor: b });
                    b = new d();
                    b.init(this, a);
                    return b;
                },
                    ...
                    e.forEach(function(b) {
                        b.isDirty &&
                            ("point" === b.options.legendType
                                ? (b.updateTotals && b.updateTotals(), (c = !0))
                                : h &&
                ...
                layOutTitles: function(b) {
                    ...
                    d[0] &&
                        ...
                        (d[0] += this.options.title.margin);
                    d[2] &&
                        "bottom" === this.options.caption.verticalAlign &&
                        (d[2] += this.options.caption.margin);
                    var l =
                        !this.titleOffset ||
                ...
                getChartSize: function() {
                    ...
                    x(a) || (this.containerHeight = d(e, "height"));
                ...
                temporaryDisplay: function(a) {
                    ...
                    if (a)
                        for (; b && b.style; )
                            b.hcOrigStyle &&
                                (r(b, b.hcOrigStyle), delete b.hcOrigStyle),
                                b.hcOrigDetached &&
                                    (W.body.removeChild(b),
                                    (b.hcOrigDetached = !1)),
                                (b = b.parentNode);
                    else
                        for (; b && b.style; ) {
                ...
                getContainer: function() {
                    ...
                    z(f) && (this.renderTo = f = W.getElementById(f));
                    f || n(13, !0, this);
                    ...
                    this.container = f = k("div", { id: l }, h, f);
                ...
                getMargins: function(b) {
                    ...
                    f[0] &&
                        !x(e[0]) &&
                        (this.plotTop = Math.max(this.plotTop, f[0] + d[0]));
                    f[2] &&
                        !x(e[2]) &&
                ...
                reflow: function(a) {
                    ...
                    if (
                        ...
                        if (h !== b.containerWidth || e !== b.containerHeight)
                            v.clearTimeout(b.reflowTimeout),
                                (b.reflowTimeout = H(
                                    function() {
                                        b.container &&
                ...
                setReflow: function(a) {
                    ...
                    !1 === a || this.unbindReflow
                        ...
                        : ((this.unbindReflow = N(aa, "resize", function(a) {
                ...
                setChartSize: function(b) {
                    ...
                    this.plotHeight = t = Math.max(
                        0,
                        Math.round(l - m - this.marginBottom)
                    );
                    ...
                    this.clipBox = {
                        ...
                        y: f,
                        width: Math.floor(
                            this.plotSizeX - Math.max(e, p[1]) / 2 - d
                        ),
                        height: Math.max(
                            0,
                            Math.floor(
                                this.plotSizeY - Math.max(e, p[2]) / 2 - f
                            )
                        )
                    };
                    b ||
                ...
                drawChartBox: function() {
                    ...
                    if (p) var A = (w = l.strokeWidth());
                        ...
                        m = { fill: m || "none" };
                        if (A || l["stroke-width"])
                            (m.stroke = b.borderColor), (m["stroke-width"] = A);
                    ...
                    h ||
                        ((q = "attr"),
                        (this.plotBackground = h = d
                            .rect()
                            .addClass("highcharts-plot-background")
                            .add()));
                    h[q](z);
                    p ||
                        (h.attr({ fill: n || "none" }).shadow(b.plotShadow),
                        t &&
                            (k
                                ? (t !== k.attr("href") && k.attr("href", t),
                                  k.animate(z))
                                : (this.plotBGImage = d
                                      .image(t, r, I, g, H)
                                      .add())));
                    x
                        ? x.animate({ width: G.width, height: G.height })
                ...
                propFromSeries: function() {
                    ...
                    ["inverted", "angular", "polar"].forEach(function(h) {
                        d = U[b.type || b.defaultSeriesType];
                        l = b[h] || (d && d.prototype[h]);
                        for (e = f && f.length; !l && e--; )
                            (d = U[f[e].type]) && d.prototype[h] && (l = !0);
                        a[h] = l;
                    });
                },
                linkSeries: function() {
                ...
                addCredits: function(a) {
                    ...
                    a.enabled &&
                        ...
                        ((this.credits = this.renderer
                            ...
                            .on("click", function() {
                                a.href && (aa.location.href = a.href);
                            })
                ...
                firstRender: function() {
                    ...
                    if (!b.isReadyToRender || b.isReadyToRender()) {
                        ...
                        q &&
                            (b.pointer =
                                c.hasTouch ||
                                (!aa.PointerEvent && !aa.MSPointerEvent)
                                    ? new q(b, d)
                                    : new E(b, d));
                        b.render();
        ...
        function(c, g) {
            ...
            u(g, "afterSetChartSize", function(g) {
                ...
                if (!this.renderer.forExport) {
                    if (v) {
                        if (
                            (this.scrollablePixelsX = v = Math.max(
                                0,
                                v - this.chartWidth
                            ))
                        ) {
                    ...
                    C &&
                        !g.skipAxes &&
                        this.axes.forEach(function(k) {
                            C[k.side]
                                ? (k.getPlotLinePath = function() {
                                      var r = C[k.side].name,
                                          g = this[r];
            ...
            g.prototype.applyFixed = function() {
                ...
                D
                    ? ((this.fixedDiv = q(
                      ...
                      (this.fixedRenderer = g = new c.Renderer(
                          this.fixedDiv,
                          this.chartWidth,
                          this.chartHeight
                      )),
                ...
                this.chartBackground.attr({ width: g, height: C });
                this.scrollablePixelsY &&
            ...
            c.LegendSymbolMixin = {
                drawRectangle: function(c, g) {
                    ...
                    g.legendSymbol = this.chart.renderer
                        .rect(
                            y ? (c.symbolWidth - v) / 2 : 0,
                            c.baseline - v + 1,
                            y ? v : c.symbolWidth,
                            v,
                            q(c.options.symbolRadius, v / 2)
                        )
                ...
                drawLineMarker: function(c) {
                    ...
                    y &&
                        !1 !== y.enabled &&
                        D &&
                        ((g = Math.min(q(y.radius, C), C)),
                        0 === this.symbol.indexOf("url") &&
                            ((y = u(y, { width: F, height: F })), (g = 0)),
                        (this.legendSymbol = y = k
                            .symbol(
                                this.symbol,
                                D / 2 - g,
                                c - g,
        ...
        function(c, g) {
            ...
            g = (function() {
                ...
                c.prototype.destroy = function() {
                    ...
                    d && d.enabled
                        ? (this.animateBeforeDestroy(), r(f, b.duration))
                        : f();
                    h.pointCount--;
                };
                ...
                c.prototype.getGraphicalProps = function(f) {
                    var a = this,
                        ...
                        h,
                        e = { singular: [], plural: [] };
                    f = f || { graphic: 1, dataLabel: 1 };
                    f.graphic && d.push("graphic", "shadowGroup");
                    f.dataLabel &&
                        d.push("dataLabel", "dataLabelUpper", "connector");
                    for (h = d.length; h--; ) {
                        var b = d[h];
                ...
                c.prototype.optionsToObject = function(f) {
                    var a = {},
                        d = this.series,
                        h = d.options.keys,
                    ...
                    if (C(f) || null === f) a[e[0]] = f;
                        ...
                        "object" === typeof f &&
                            ((a = f),
                            f.dataLabels && (d._hasPointLabels = !0),
                            f.marker && (d._hasPointMarkers = !0));
                    return a;
                };
                c.prototype.resolveColor = function() {
                    ...
                    f.options.colorByPoint
                        ? (d ||
                              ((a = f.options.colors || f.chart.options.colors),
                              (this.color = this.color || a[f.colorCounter]),
                              (a = a.length)),
                          (d = f.colorCounter),
                          f.colorCounter++,
                          f.colorCounter === a && (f.colorCounter = 0))
                        : (d = f.colorIndex);
                ...
                c.prototype.tooltipFormatter = function(f) {
                    var a = this.series,
                        ...
                        b = d.valueSuffix || "";
                    a.chart.styledMode &&
                        (f = a.chart.tooltip.styledModeFormat(f));
                    ...
                    return N(f, { point: this, series: this.series }, a.chart);
                };
                return c;
            })();
            c.Point = g;
                ...
                },
                {
                    ...
                    init: function(d, f) {
                        ...
                        f.dataSorting && f.dataSorting.enabled
                            ...
                            : e.points || e.data || e.setData(f.data, !1);
                        n(this, "afterInit");
                    },
                    is: function(a) {
                    ...
                    setOptions: function(a) {
                        ...
                        l = e(
                            c,
                            f.series,
                            l.plotOptions && l.plotOptions[this.type],
                            a
                        );
                        this.tooltipOptions = e(
                            K.tooltip,
                            K.plotOptions.series &&
                                K.plotOptions.series.tooltip,
                        ...
                        (!l.negativeColor && !l.negativeFillColor) ||
                            l.zones ||
                            ((f = {
                                value:
                                    l[this.zoneAxis + "Threshold"] ||
                                    l.threshold ||
                                    0,
                                className: "highcharts-negative"
                            }),
                            b ||
                                ((f.color = l.negativeColor),
                                (f.fillColor = l.negativeFillColor)),
                            d.push(f));
                        d.length &&
                            k(d[d.length - 1].value) &&
                            d.push(
                                b
                                    ? {}
                                    : {
                        ...
                        n(this, "afterSetOptions", { options: l });
                        return l;
                    },
                    getName: function() {
                        return p(
                    ...
                    findPointIndex: function(a, b) {
                        ...
                        if (f) var p = this.chart.get(f);
                            ...
                            var k = c && c.matchByName ? "name" : "index";
                            p = L(l, function(b) {
                    ...
                    updateData: function(a, b) {
                        ...
                        a.forEach(function(a, b) {
                            ...
                            if (p.id || d(w)) {
                                if (
                                    ((w = this.findPointIndex(p, m)),
                                    -1 === w || "undefined" === typeof w
                                        ? h.push(a)
                                        : l[w] && a !== f.data[w]
                                        ? (l[w].update(a, !1, null, !1),
                                          (l[w].touched = !0),
                                          n && (m = w + 1))
                                        : l[w] && (l[w].touched = !0),
                                    !t ||
                            ...
                            if (r && n > r)
                                ...
                                for (e = 0; e < n; e++)
                                    "undefined" !== typeof a[e] &&
                                        ...
                                        l.updateParallelArrays(c, e));
                            q && h(q[0]) && x(14, !0, t);
                            l.data = [];
                            l.options.data = l.userOptions.data = a;
                            for (e = m; e--; )
                                k[e] && k[e].destroy && k[e].destroy();
                    ...
                    processData: function(a) {
                        ...
                        if (
                            ...
                            this.sorted &&
                            !p &&
                            (!c || f > c || this.forceCrop)
                        )
                            if (b[f - 1] < w || b[0] > t) (b = []), (d = []);
                            else if (this.yData && (b[0] < w || b[f - 1] > t)) {
                        ...
                        for (c = b.length || 1; --c; )
                            if (
                                ((f = m
                                    ? h(b[c]) - h(b[c - 1])
                                    : b[c] - b[c - 1]),
                                0 < f && ("undefined" === typeof r || f < r))
                            )
                                var r = f;
                            else
                                0 > f && n && (x(15, !1, this.chart), (n = !1));
                        this.cropped = g;
                        this.cropStart = e;
                        ...
                        for (r = 0; r < p; r++) {
                            ...
                            if (t) {
                                ...
                                q.dataGroup.options &&
                                    ...
                                    m(q, q.dataGroup.options),
                                    delete q.dataLabels);
                            } else
                                (q = d[z]) ||
                                    "undefined" === typeof b[z] ||
                                    (d[z] = q = new c().init(this, b[z], e[r]));
                            q && ((q.index = z), (g[r] = q));
                        }
                        this.options.keys = a;
                        if (d && (p !== (f = d.length) || t))
                        ...
                        for (g = 0; g < t; g++) {
                            var J = w[g],
                                ...
                                M =
                                    b &&
                                    m.stacks[
                                        (this.negStacks && S < (G ? 0 : x)
                                            ? "-"
                                            : "") + this.stackKey
                                    ];
                            m.positiveValuesOnly &&
                                null !== S &&
                                0 >= S &&
                                (J.isNull = !0);
                            J.plotX = A = C(
                            ...
                            f(Q) &&
                                ...
                                y === G &&
                                    u.key === M[L].base &&
                                    (y = p(d(x) && x, m.min)),
                                m.positiveValuesOnly && 0 >= y && (y = null),
                                (J.total = J.stackTotal = D.total),
                                (J.percentage =
                                    D.total && (J.y / D.total) * 100),
                                (J.stackY = S),
                            ...
                            J.yBottom = k(y)
                                ? F(m.translate(y, 0, 1, 0, 1), -1e5, 1e5)
                                : null;
                            r && (S = this.modifyValue(S, J));
                            J.plotY =
                                "number" === typeof S && Infinity !== S
                                    ? F(m.translate(S, 0, 1, 0, 1), -1e5, 1e5)
                                    : void 0;
                            J.isInside = this.isPointInside(J);
                            J.clientX = q
                                ? C(e.translate(L, 0, 0, 0, 1, z))
                                : A;
                            J.negative = J[K] < (a[K + "Threshold"] || x || 0);
                            J.category =
                                h && "undefined" !== typeof h[J.x]
                                    ? h[J.x]
                                    : J.x;
                            if (!J.isNull && !1 !== J.visible) {
                                "undefined" !== typeof E &&
                                    (v = Math.min(v, Math.abs(A - E)));
                                var E = A;
                            }
                    ...
                    setClip: function(a) {
                        ...
                        a &&
                            ...
                            f &&
                                (h.x =
                                    b.plotHeight +
                                    (!1 !== d.clip ? 0 : b.plotTop)));
                        p
                            ? b.hasLoaded || p.attr(h)
                            : (a &&
                                  (b[c + "m"] = k = e.clipRect(
                                      f ? b.plotSizeX + 99 : -99,
                        ...
                        if (!1 !== d.clip || a)
                            this.group.clip(a || l ? p : b.clipRect),
                                this.markerGroup.clip(k),
                                (this.sharedClipKey = c);
                        a ||
                            (p.count[this.index] &&
                            ...
                            for (d = 0; d < a.length; d++) {
                                ...
                                if (
                                    ...
                                    this.enabledDataSorting &&
                                        (m.startXPos = c.reversed
                                            ? -g.width
                                            : c.width);
                                    var z = !1 !== m.isInside;
                                    e
                                        ? e[z ? "show" : "hide"](z).animate(g)
                                        : z &&
                                          (0 < g.width || m.hasImage) &&
                    ...
                    pointAttribs: function(a, b) {
                        ...
                        e = p(
                            b.lineWidth,
                            d.lineWidth,
                            e + p(b.lineWidthPlus, d.lineWidthPlus, 0)
                        );
                    ...
                    destroy: function(a) {
                        ...
                        for (c = l.length; c--; )
                            (p = l[c]) && p.destroy && p.destroy();
                        d.points = null;
                        q.clearTimeout(d.animationTimeout);
                        b(d, function(a, b) {
                            a instanceof S &&
                                !a.survive &&
                                ((h = f && "group" === b ? "hide" : "destroy"),
                                a[h]());
                        });
                    ...
                    drawGraph: function() {
                        var a = this,
                            b = this.options,
                            d = (this.gappedPath || this.getGraphPath).call(
                                this
                            ),
                            e = this.chart.styledMode,
                    ...
                    applyZones: function() {
                        ...
                        if (
                            ...
                            e.forEach(function(e, l) {
                                ...
                                h = F(
                                    Math.round(
                                        t.toPixels(p(e.value, K.max), !0) || 0
                                    ),
                                    0,
                                    w
                                );
                    ...
                    invertGroups: function(a) {
                        ...
                        var d = this,
                            e = d.chart;
                        d.xAxis &&
                            (d.eventsToUnbind.push(y(e, "resize", b)),
                            b(),
                            (d.invertGroups = b));
                    },
                    plotGroup: function(a, b, d, e, f) {
                        ...
                        h.attr({ visibility: d })[c ? "attr" : "animate"](
                            this.getPlotBox()
                        );
                        return h;
                    },
                    ...
                    buildKDTree: function(a) {
                        ...
                        var d = this,
                            e =
                                -1 < d.options.findNearestPointBy.indexOf("y")
                                    ? 2
                                    : 1;
                        delete d.kdTree;
                        G(
                            function() {
                                d.kdTree = b(
                                    d.getValidPoints(null, !d.directTouch),
                                    e,
                                    e
                                );
                                d.buildingKdTree = !1;
                            },
                            d.options.kdNow || (a && "touchstart" === a.type)
                                ? 0
                                : 1
                        );
                    },
                    searchKDTree: function(a, b, d) {
                        ...
                        var f = this,
                            ...
                            l = b ? "distX" : "dist";
                        b =
                            -1 < f.options.findNearestPointBy.indexOf("y")
                                ? 2
                                : 1;
                        this.kdTree ||
                            this.buildingKdTree ||
    ...
    P(
        ...
        function(c, g) {
            ...
            var F = c.Chart,
                C = c.Series;
            c.StackItem = function(c, g, q, m, v) {
                ...
                this.alignOptions = {
                    ...
                    verticalAlign:
                        g.verticalAlign ||
                        (k ? "middle" : q ? "bottom" : "top"),
                    y: g.y,
                    x: g.x
                };
                this.textAlign =
                    g.textAlign || (k ? (q ? "right" : "left") : "center");
            };
            c.StackItem.prototype = {
                ...
                render: function(c) {
                    ...
                    this.label
                        ...
                        : ((this.label = k.renderer.label(
                          ...
                          this.label.attr(m),
                          k.styledMode || this.label.css(g.style),
                ...
                setOffset: function(c, g, x, m, v) {
                    var k = this.axis,
                        r = k.chart;
                    m = k.translate(
                        k.usePercentage ? 100 : m ? m : this.total,
                        0,
                        0,
                        0,
                        1
                    ...
                    g &&
                        ...
                        (f =
                            "left" === f
                                ...
                                ? x
                                    ...
                                    : -m
                                : v.width / 2),
                        (x = r.inverted ? v.height / 2 : x ? -m : v.height),
                        (this.alignOptions.x = D(this.options.x, 0)),
                        (this.alignOptions.y = D(this.options.y, 0)),
                        (k.x -= f),
                        (k.y -= x),
                        g.align(this.alignOptions, null, k),
                        r.isInsidePlot(
                            g.alignAttr.x + f - this.alignOptions.x,
                            g.alignAttr.y + x - this.alignOptions.y
                        )
                            ? g.show()
                        ...
                        D(!c && this.options.crop, !0) &&
                            ((r =
                                r.isInsidePlot(g.x - m + g.width, g.y) &&
                                r.isInsidePlot(g.x + m, g.y)) ||
                                g.hide()));
                },
                getStackBox: function(c, g, q, m, v, n, y) {
                    var f = g.axis.reversed,
                        a = c.inverted;
                    c = y.height + y.pos - (a ? c.plotLeft : c.plotTop);
            ...
            F.prototype.getStacks = function() {
                ...
                c.series.forEach(function(k) {
                    ...
                    !k.options.stacking ||
                        (!0 !== k.visible &&
                            !1 !== c.options.chart.ignoreHiddenSeries) ||
                        (k.stackKey = [
                            k.type,
                            D(k.options.stack, ""),
                            g ? m.top : m.left,
            ...
            C.prototype.setStackedPoints = function() {
                if (
                    ...
                    for (t = 0; t < m; t++) {
                        ...
                        b[J][w] ||
                            (p[J] && p[J][w]
                                ? ((b[J][w] = p[J][w]), (b[J][w].total = null))
                                : (b[J][w] = new c.StackItem(
                                      e,
                        ...
                        J = b[J][w];
                        null !== G
                            ? ((J.points[C] = J.points[this.index] = [
                                  D(J.cumulative, y)
                              ]),
                              q(J.cumulative) || (J.base = C),
                              (J.touched = e.stacksTouched),
                              0 < K.index &&
                                  !1 === this.singleStacks &&
                                  (J.points[C][0] =
                                      J.points[this.index + "," + w + ",0"][0]))
                            : (J.points[C] = J.points[this.index] = null);
                        "percent" === v
                            ? ((z = z ? a : d),
                              h && b[z] && b[z][w]
                                  ? ((z = b[z][w]),
                                    (J.total = z.total =
                                        Math.max(z.total, J.total) +
                                            Math.abs(G) || 0))
                                  : (J.total = u(J.total + (Math.abs(G) || 0))))
                            : (J.total = u(J.total + (G || 0)));
                        J.cumulative = D(J.cumulative, y) + (G || 0);
                        null !== G &&
                            (J.points[C].push(J.cumulative),
                            (x[t] = J.cumulative));
                    }
                ...
                c[n + "Stacker"] &&
                    [g, "-" + g].forEach(function(k) {
                        for (var f = m.length, a, d; f--; )
                            if (
                                ((a = m[f]),
                                (v = c.getStackIndicator(v, a, c.index, k)),
                                (d = (a = q[k] && q[k][a]) && a.points[v.key]))
                            )
                                c[n + "Stacker"](d, a, f);
                    });
            };
    ...
    P(
        ...
        function(c, g, u, q) {
            ...
            c.cleanRecursively = function(b, d) {
                var e = {};
                a(b, function(a, f) {
                    if (n(b[f], !0) && !b.nodeType && d[f])
                        (a = c.cleanRecursively(b[f], d[f])),
                            Object.keys(a).length && (e[f] = a);
            ...
            r(q.prototype, {
                addSeries: function(a, b, e) {
                    ...
                    a &&
                        ((b = d(b, !0)),
                        x(c, "addSeries", { options: a }, function() {
                            f = c.initSeries(a);
                            c.isDirtyLegend = !0;
                            c.linkSeries();
                            f.enabledDataSorting && f.setData(a.data, !1);
                            x(c, "afterAddSeries", { series: f });
                            b && c.redraw(e);
                        }));
                    return f;
                },
                ...
                showLoading: function(a) {
                    ...
                    b.styledMode ||
                        (D(f, r(c.style, { zIndex: 10 })),
                        D(b.loadingSpan, c.labelStyle),
                        b.loadingShown ||
                ...
                update: function(e, p, k, m) {
                    var n = this,
                        ...
                        l,
                        w,
                        r = e.isResponsiveOptions,
                        z = [];
                    x(n, "update", { options: e });
                    ...
                    if ((t = e.chart)) {
                        ...
                        a(t, function(a, b) {
                            ...
                            -1 !== n.propsRequireDirtyBox.indexOf(b) &&
                                (n.isDirtyBox = !0);
                            r ||
                                -1 === n.propsRequireReflow.indexOf(b) ||
                                (w = !0);
                        });
                        !n.styledMode &&
                            "style" in t &&
                            n.renderer.setStyle(t.style);
                    }
                    !n.styledMode &&
                        e.colors &&
                        (this.options.colors = e.colors);
                    e.plotOptions &&
                        f(!0, this.options.plotOptions, e.plotOptions);
                    e.time &&
                        this.time === c.time &&
                        (this.time = new u(e.time));
                    a(e, function(a, b) {
                        if (n[b] && "function" === typeof n[b].update)
                            n[b].update(a, !1);
                        else if ("function" === typeof n[g[b]]) n[g[b]](a);
                        "chart" !== b &&
                            -1 !== n.propsRequireUpdateSeries.indexOf(b) &&
                            (l = !0);
                    });
                    this.collectionsWithUpdate.forEach(function(a) {
                        if (e[a]) {
                            ...
                            b(e[a]).forEach(function(b, d) {
                                ...
                                !d &&
                                    k &&
                                    n.collectionsWithInit[a] &&
                                    (n.collectionsWithInit[a][0].apply(
                                        n,
                                        [b]
                                            .concat(
                                                n.collectionsWithInit[a][1] ||
                                                    []
                                            )
                                            .concat([!1])
                                    ).touched = !0);
                    ...
                    l &&
                        n.getSeriesOrderByLinks().forEach(function(a) {
                            a.chart && a.update({}, !1);
                        }, this);
            ...
            r(g.prototype, {
                update: function(a, b, e, f) {
                    ...
                    !1 === f
                        ? c()
                        : h.firePointEvent("update", { options: a }, c);
                },
                remove: function(a, b) {
            ...
            r(z.prototype, {
                addPoint: function(a, b, e, f, c) {
                    ...
                    e &&
                        (p[0] && p[0].remove
                            ? p[0].remove(!1)
                            : (p.shift(),
                              this.updateParallelArrays(t, "shift"),
                              m.shift()));
                    !1 !== c && x(this, "addPoint", { point: t });
                ...
                update: function(a, b) {
                    ...
                    var e = this,
                        ...
                        v = e.finishedAnimating && { animation: !1 },
                        G = {};
                    l &&
                        (q.push(
                            "data",
                        ...
                        a.data &&
                            (a.dataSorting &&
                                r(e.options.dataSorting, a.dataSorting),
                    ...
                    a = f(
                        ...
                        {
                            index:
                                "undefined" === typeof p.index
                                    ? e.index
                                    : p.index,
                            pointStart: d(p.pointStart, e.xData[0])
                        },
                        !l && { data: e.options.data },
                        a
                    );
                    ...
                    if (l && this.points) {
                        var y = e.options;
                        !1 === y.visible
                            ? ((G.graphic = 1), (G.dataLabel = 1))
                            : e._hasPointLabels ||
                              ((n = y.marker),
                              (g = y.dataLabels),
                              n &&
                                  (!1 === n.enabled || "symbol" in n) &&
                                  (G.graphic = 1),
                              g && !1 === g.enabled && (G.dataLabel = 1));
                        this.points.forEach(function(a) {
                            a &&
                                a.series &&
                                (a.resolveColor(),
                                Object.keys(G).length && a.destroyElements(G),
                                !1 === y.showInLegend &&
                                    a.legendItem &&
                                    h.legend.destroyItem(a));
                        }, this);
                    }
                    a.zIndex !== p.zIndex &&
                ...
                { softThreshold: !1, threshold: 0 },
                {
                    ...
                    getGraphPath: function(c) {
                        ...
                        for (m = 0; m < c.length; m++) {
                            r ||
                                (c[m].leftCliff = c[m].rightCliff = c[
                                    m
                                ].leftNull = c[m].rightNull = void 0);
                            var e = c[m].isNull;
                    ...
                    drawGraph: function() {
                        ...
                        r.forEach(function(r) {
                            var m = r[0],
                                ...
                                v = {};
                            q
                                ? ((q.endX = c.preventGraphAnimation
                                      ? null
                                      : g.xMap),
                                  q.animate({ d: g }))
                                : ((v.zIndex = 0),
                                  (q = c[m] = c.chart.renderer
                                      .path(g)
                                      .addClass(r[1])
                                      .add(c.group)),
                                  (q.isArea = !0));
                            c.chart.styledMode ||
                                (v.fill = E(
                                    r[3],
                                    y(r[2])
                                        .setOpacity(E(k.fillOpacity, 0.75))
                                        .get()
                                ));
                            q[n](v);
                            q.startX = g.xMap;
            ...
            {},
            {
                getPointSpline: function(c, q, y) {
                    ...
                    if (
                        ...
                        x += C;
                        r > c && r > u
                            ? ((r = Math.max(c, u)), (x = 2 * u - r))
                            : r < c &&
                              r < u &&
                              ((r = Math.min(c, u)), (x = 2 * u - r));
                        x > y && x > u
                            ? ((x = Math.max(y, u)), (r = 2 * u - x))
                            : x < y &&
                              x < u &&
                              ((x = Math.min(y, u)), (r = 2 * u - x));
                        q.rightContX = E;
                        q.rightContY = x;
                    }
                    q = [
                        "C",
                        g(D.rightContX, D.plotX),
                        g(D.rightContY, D.plotY),
                        g(k, v),
                        g(r, u),
                        v,
                        u
                ...
                },
                {
                    ...
                    getColumnMetrics: function() {
                        ...
                        var e = Math.min(
                            ...
                            p = (e - 2 * b) / (h || 1);
                        k = Math.min(
                            k.maxPointWidth || n.len,
                            r(k.pointWidth, p * (1 - 2 * k.pointPadding))
                        );
                        c.columnMetrics = {
                            width: k,
                            offset:
                    ...
                    crispCol: function(c, k, n, g) {
                        ...
                        this.options.crisp &&
                            ...
                            (n -= c));
                        g = Math.round(k + g) + a;
                        d = 0.5 >= Math.abs(k) && 0.5 < g;
                        k = Math.round(k) + a;
                        g -= k;
                        d && g && (--k, (g += 1));
                        return { x: c, y: k, width: n, height: g };
                    },
                    translate: function() {
                        var c = this,
                            k = c.chart,
                            n = c.options,
                            g = (c.dense =
                                2 > c.closestPointRange * c.xAxis.transA);
                        ...
                        c.points.forEach(function(b) {
                            ...
                            D(b.options.pointWidth) &&
                                ((n = x = Math.ceil(b.options.pointWidth)),
                                (l -= Math.round((n - p) / 2)));
                            b.barX = l;
                            b.pointWidth = n;
                            b.tooltipPos = k.inverted
                                ? [
                                      a.len + a.pos - k.plotLeft - m,
                                      f.len +
                                          f.pos -
                                          k.plotTop -
                                          (z || 0) -
                                ...
                                : [l + x / 2, m + a.pos - k.plotTop, y];
                            b.shapeType =
                                c.pointClass.prototype.shapeType || "rect";
                            b.shapeArgs = c.crispCol.apply(
                                c,
                                b.isNull ? [l, h, x, 0] : [l, G, x, y]
                            );
                        });
                    },
                    getSymbol: c.noop,
                    ...
                    drawPoints: function() {
                        ...
                        c.points.forEach(function(d) {
                            var h = d.graphic,
                                e = !!h,
                                b = h && g.pointCount < f ? "animate" : "attr";
                            if (C(d.plotY) && null !== d.y) {
                                ...
                                c.enabledDataSorting &&
                                    (d.startXPos = c.xAxis.reversed
                                        ...
                                        : c.xAxis.width);
                                h ||
                                    ((d.graphic = h = r[d.shapeType](a).add(
                                        d.group || c.group
                                    )) &&
                                        c.enabledDataSorting &&
                                        g.hasRendered &&
                                        ...
                                        (b = "animate")));
                                if (h && e) h[b](k(a));
                                if (n.borderRadius) h[b]({ r: n.borderRadius });
                                g.styledMode ||
                                    h[b](
                                        c.pointAttribs(
                                            d,
                    ...
                    animate: function(c) {
                        ...
                        if (c)
                            (a.scaleY = 0.001),
                                (c = E(
                                    g.toPixels(m.threshold),
                                    g.pos,
                                    g.pos + g.len
                                )),
                                f
                                    ? (a.translateX = c - g.len)
                                    : (a.translateY = c),
                                k.clipBox && k.setClip(),
                                k.group.attr(a);
                        else {
            ...
            g(
                ...
                },
                {
                    ...
                    applyJitter: function() {
                        ...
                        g &&
                            this.points.forEach(function(v, y) {
            ...
            c.CenteredSeriesMixin = {
                getCenter: function() {
                    ...
                    c = [
                        q(r[0], "50%"),
                        q(r[1], "50%"),
                        q(m && 0 > m ? void 0 : c.size, "100%"),
                        q(E && 0 > E ? void 0 : c.innerSize || 0, "0%")
                    ];
                    g.angular && (c[3] = 0);
                    for (r = 0; 4 > r; ++r)
                        (m = c[r]),
                            (g = 2 > r || (2 === r && /%$/.test(m))),
                            (c[r] = y(m, [u, k, x, c[2]][r]) + (g ? v : 0));
                    c[3] > c[2] && (c[3] = c[2]);
                    return c;
                },
                getStartAndEndRadians: function(c, g) {
                    ...
                    return { start: v * (c + -90), end: v * (g + -90) };
                }
            };
        }
    );
            ...
            x(
                ...
                },
                {
                    ...
                    updateTotals: function() {
                        ...
                        for (f = 0; f < c; f++) {
                            var b = d[f];
                            a += e && !b.visible ? 0 : b.isNull ? 0 : b.y;
                        }
                        this.total = a;
                        for (f = 0; f < c; f++)
                            (b = d[f]),
                    ...
                    getX: function(f, a, d) {
                        ...
                        f = Math.asin(
                            v((f - c[1]) / (e + d.labelDistance), -1, 1)
                        );
                        return (
                            c[0] +
                            (a ? -1 : 1) * Math.cos(f) * (e + d.labelDistance) +
                            (0 < d.labelDistance
                    ...
                    translate: function(f) {
                        ...
                        for (m = 0; m < q; m++) {
                            ...
                            v.tooltipPos = [f[0] + 0.7 * y, f[1] + 0.7 * A];
                            v.half =
                                u < -Math.PI / 2 || u > Math.PI / 2 ? 1 : 0;
                            v.angle = u;
                        ...
                        f.points.forEach(function(h) {
                            ...
                            if (!h.isNull && e) {
                                ...
                                h.delayedRendering
                                    ...
                                    : (e.setRadialReference(f.center),
                                      a.styledMode || C(!0, g, b),
                                      C(!0, g, p, c),
                                      e.animate(g));
                                e.attr({
                    ...
                    drawPoints: function() {
                        ...
                        this.points.forEach(function(a) {
                            ...
                            a.graphic ||
                                ((a.graphic = f[a.shapeType](a.shapeArgs).add(
                                    a.series.group
                                )),
                ...
                },
                {
                    ...
                    setVisible: function(f, a) {
                        ...
                        a = k(a, b);
                        f !== d.visible &&
                            ((d.visible = d.options.visible = f =
                                "undefined" === typeof f ? !d.visible : f),
                            ...
                            d.legendItem && e.legend.colorizeItem(d, f),
                            f || "hover" !== d.state || d.setState(""),
                            b && (c.isDirty = !0),
                            a && e.redraw());
                    },
                    slice: function(f, a, d) {
                        ...
                        m(d, c.chart);
                        k(a, !0);
                        this.sliced = this.options.sliced = E(f)
                            ? f
                            : !this.sliced;
        ...
        function(c, g) {
                    ...
                    for (e = f.length; e--; )
                        (b = f[e]),
                            (n =
                                ...
                                2),
                            (b.pos = y(n - b.size * b.align, 0, a - b.size));
                    e = f.length;
                    for (b = !1; e--; )
                        0 < e &&
                            f[e - 1].pos + f[e - 1].size > f[e].pos &&
                            ((f[e - 1].size += f[e].size),
                            (f[e - 1].targets = f[e - 1].targets.concat(
                                f[e].targets
                            )),
                            (f[e - 1].align = 0.5),
                            f[e - 1].pos + f[e - 1].size > a &&
                                (f[e - 1].pos = a - f[e - 1].size),
                            f.splice(e, 1),
                            (b = !0));
                }
                k.push.apply(k, g);
                ...
                f.some(function(b) {
                    ...
                    if (
                        b.targets.some(function() {
                            ...
                            if (
                                "undefined" !== typeof d &&
                                Math.abs(k[e].pos - k[e].target) > d
                            )
                                return (
                                    k.slice(0, e + 1).forEach(function(a) {
                                        delete a.pos;
                                    }),
                                    (k.reducedLen =
                                        (k.reducedLen || a) - 0.1 * a),
                                    k.reducedLen > 0.1 * a &&
                                        c.distribute(k, a, d),
                                    !0
                                );
            ...
            n.prototype.drawDataLabels = function() {
                ...
                b = a(
                    a(
                        ...
                        h.options.plotOptions &&
                            h.options.plotOptions[d.type] &&
                            h.options.plotOptions[d.type].dataLabels
                    ),
                    b
                );
                    ...
                    p.forEach(function(c) {
                        ...
                        g.forEach(function(a, b) {
                            ...
                            if (l) {
                                ...
                                var q = r(
                                    a[c.formatPrefix + "Format"],
                                    a.format
                                );
                                t = v(q)
                                    ? D(q, t, h)
                                    : (
                                          a[c.formatPrefix + "Formatter"] ||
                                          a.formatter
                                      ).call(t, a);
                                q = a.style;
                                var w = a.rotation;
                                ...
                                h.styledMode ||
                                    ((z.fill = a.backgroundColor),
                                    (z.stroke = a.borderColor),
                                    (z["stroke-width"] = a.borderWidth));
                                k(z, function(a, b) {
                            ...
                            !p || (l && v(t))
                                ? l &&
                                  ...
                                  (p.options = a),
                                  p.attr(z),
                                  h.styledMode || p.css(q).shadow(a.shadow),
                                  p.added || p.add(J),
                                  a.textPath &&
                                      !a.useHTML &&
                                      (p.setTextPath(
                                          (c.getDataLabelPath &&
                                              c.getDataLabelPath(p)) ||
                                              c.graphic,
                                          a.textPath
                                      ),
                                      c.dataLabelPath &&
            ...
            n.prototype.alignDataLabel = function(f, a, d, c, e) {
                var b = this,
                    ...
                    y = "justify" === r(d.overflow, g ? "none" : "justify"),
                    l =
                        this.visible &&
                        !1 !== f.visible &&
                        (f.series.forceDL ||
                ...
                if (l) {
                    var E = h.renderer.fontMetrics(
                        h.styledMode ? void 0 : d.style.fontSize,
                        a
                    ).b;
                    c = N(
                        {
                    ...
                    N(d, { width: q.width, height: q.height });
                    v
                        ? ((y = !1),
                          (n = h.renderer.rotCorr(E, v)),
                          (n = {
                          ...
                          C(n),
                          a[e ? "attr" : "animate"](n).attr({ align: x }),
                          (C = (v + 720) % 360),
                          (C = 180 < C && 360 > C),
                          "left" === x
                              ? (n.y -= C ? q.height : 0)
                              : "center" === x
                              ? ((n.x -= q.width / 2), (n.y -= q.height / 2))
                              : "right" === x &&
                                ((n.x -= q.width), (n.y -= C ? 0 : q.height)),
                          (a.placed = !0),
                          (a.alignAttr = n))
                        : (C(c), a.align(d, null, c), (n = a.alignAttr));
                    y && 0 <= c.height
                        ? this.justifyDataLabel(a, d, n, q, c, e)
                        : r(d.crop, !0) &&
                          (l =
                              h.isInsidePlot(n.x, n.y) &&
                              h.isInsidePlot(n.x + q.width, n.y + q.height));
                    if (d.shape && !v)
                        a[e ? "attr" : "animate"]({
            ...
            n.prototype.setDataLabelStartPos = function(f, a, d, c, e) {
                ...
                c
                    ...
                    : a
                          .attr({ opacity: 1 })
                          .animate({ opacity: 0 }, void 0, a.hide);
                b.hasRendered &&
                    (d && a.attr({ x: a.startXPos, y: a.startYPos }),
                    (a.placed = !0));
            };
            ...
            M.pie &&
                ...
                (M.pie.prototype.drawDataLabels = function() {
                    ...
                    f.visible &&
                        ...
                        n.prototype.drawDataLabels.apply(f),
                        a.forEach(function(a) {
                            a.dataLabel &&
                                (a.visible
                                    ? (D[a.half].push(a),
                        ...
                        D.forEach(function(a, k) {
                            var p = a.length,
                                ...
                                t;
                            if (p) {
                                f.sortByAngle(a, k - 0.5);
                                if (0 < f.maxLabelDistance) {
                                    var q = Math.max(
                                        0,
                                        E - J - f.maxLabelDistance
                                    );
                                    var z = Math.min(
                                        E + J + f.maxLabelDistance,
                                        h.plotHeight
                                ...
                                for (B = 0; B < p; B++) {
                                    ...
                                    H = d.labelPosition;
                                    A = d.dataLabel;
                                    L = !1 === d.visible ? "hidden" : "inherit";
                                    F = q = H.natural.y;
                                    n &&
                                        v(d.distributeBox) &&
                                        ("undefined" ===
                                        typeof d.distributeBox.pos
                                            ? (L = "hidden")
                                            : ((I = d.distributeBox.size),
                                              (F = P.radialDistributionY(d))));
                                    delete d.positionIndex;
                                    if (e.justify) M = P.justify(d, J, y);
                                    else
                                        switch (e.alignTo) {
                                            case "connectors":
                                                M = P.alignToConnectors(
                                                    a,
                                                    k,
                                                    g,
                                                    w
                        ...
                        0 === q(N) || this.verifyDataLabelOverflow(N)) &&
                        (this.placeDataLabels(),
                        this.points.forEach(function(a) {
                            Y = C(e, a.options.dataLabels);
                            if ((k = r(Y.connectorWidth, 1))) {
                                var b;
                                u = a.connector;
                                if (
                                    (A = a.dataLabel) &&
                ...
                (M.pie.prototype.alignDataLabel = g),
                (M.pie.prototype.verifyDataLabelOverflow = function(f) {
                    var a = this.center,
                        d = this.options,
                        c = d.center,
                        e = d.minSize || 80,
                    ...
                    if (!b) {
                        if (null !== c[0])
                            var k = Math.max(a[2] - Math.max(f[1], f[3]), e);
                        else
                            (k = Math.max(a[2] - f[1] - f[3], e)),
                                (a[0] += (f[3] - f[1]) / 2);
                        null !== c[1]
                            ? (k = y(k, e, a[2] - Math.max(f[0], f[2])))
                            : ((k = y(k, e, a[2] - f[0] - f[2])),
                              (a[1] += (f[0] - f[2]) / 2));
                        k < a[2]
                            ? ((a[2] = k),
                              (a[3] = Math.min(x(d.innerSize || 0, k), k)),
                              this.translate(a),
            ...
            M.column &&
                (M.column.prototype.alignDataLabel = function(f, a, d, c, e) {
                    var b = this.chart.inverted,
                        h = f.series,
                        k = f.dlBox || f.shapeArgs,
                        g = r(
                            f.below,
                            f.plotY > r(this.translatedThreshold, h.yAxis.len)
                        ),
                        m = r(d.inside, !!this.options.stacking);
                    k &&
                        ((c = C(k)),
                        0 > c.y && ((c.height += c.y), (c.y = 0)),
                        (k = c.y + c.height - h.yAxis.len),
                        0 < k && k < c.height && (c.height -= k),
                        b &&
                            (c = {
                        ...
                        m ||
                            (b
                                ? ((c.x += g ? 0 : c.width), (c.width = 0))
                                : ((c.y += g ? c.height : 0), (c.height = 0))));
                    d.align = r(
                        d.align,
                        !b || m ? "center" : g ? "right" : "left"
                    );
                    d.verticalAlign = r(
                        d.verticalAlign,
                        b || m ? "middle" : g ? "top" : "bottom"
                    );
                    n.prototype.alignDataLabel.call(this, f, a, d, c, e);
                    d.inside &&
                        f.contrastColor &&
                        a.css({ color: f.contrastColor });
                });
        }
    );
    P(
            ...
            u(c, "render", function() {
                ...
                (this.series || []).forEach(function(g) {
                    ...
                    g.visible &&
                        ...
                        (g.nodes || g.points).forEach(function(k) {
                            k.visible &&
                                (y(k.dataLabels)
                                    ? k.dataLabels
                                    : k.dataLabel
                                    ...
                                    g.labelrank = N(
                                        q.labelrank,
                                        k.labelrank,
                                        k.shapeArgs && k.shapeArgs.height
                                    );
                ...
                var n = function(a) {
                    ...
                    if (a && (!a.alignAttr || a.placed)) {
                        ...
                        a.width ||
                            ...
                            (a.width = f.width),
                            (a.height = f.height),
                            (f = k.fontMetrics(null, a.element).h));
                        return {
        ...
        function(c, g, u, q) {
            ...
            c = c.TrackerMixin = {
                ...
                drawTrackerGraph: function() {
                    var b = this,
                        ...
                        v = "rgba(192,192,192," + (e ? 0.0001 : 0.002) + ")";
                    if (h && !f)
                        for (r = h + 1; r--; )
                            "M" === c[r] &&
                                c.splice(r + 1, 0, c[r + 1] - m, c[r + 2], "L"),
                                ((r && "M" === c[r]) || r === h) &&
                                    c.splice(r, 0, "L", c[r - 2] + m, c[r - 1]);
                    q
                        ? q.attr({ d: c })
                        : b.graph &&
                          ((b.tracker = n
                          ...
                          k.styledMode ||
                              b.tracker.attr({
                                  ...
                                  fill: f ? v : "none",
                                  "stroke-width":
                                      b.graph.strokeWidth() + (f ? 0 : 2 * m)
                              }),
                          [b.tracker, b.markerGroup].forEach(function(b) {
                              b.addClass("highcharts-tracker")
                                  .on("mouseover", l)
                                  .on("mouseout", function(a) {
            ...
            F(g.prototype, {
                setItemEvents: function(a, d, e) {
                    ...
                    (e ? [d, a.legendSymbol] : [a.legendGroup]).forEach(
                        function(e) {
                            if (e)
            ...
            F(q.prototype, {
                ...
                zoom: function(a) {
                    ...
                    !a || a.resetSelection
                        ...
                        : a.xAxis.concat(a.yAxis).forEach(function(a) {
                              ...
                              e[l ? "zoomX" : "zoomY"] &&
                                  p &&
                                  ((d = h.zoom(a.min, a.max)),
                                  h.displayBtn && (f = !0));
                          });
                    var h = b.resetZoomButton;
                    f && !h
                        ? b.showResetZoom()
                        : !f && x(h) && (b.resetZoomButton = h.destroy());
                    d &&
                        b.redraw(
                            n(
                                b.options.chart.animation,
                ...
                pan: function(a, d) {
                    ...
                    var h = d.type;
                    C(this, "pan", { originalEvent: a }, function() {
                        e &&
                            e.forEach(function(a) {
                                a.setState();
                            });
                        ...
                        d.forEach(function(d) {
                            ...
                            n = Math.min(
                                ...
                                p
                                    ? m.min
                                    : e.toValue(
                                          e.toPixels(m.min) - e.minPixelPadding
                                      )
                            );
                            p = Math.max(
                                m.dataMax,
                                p
                                    ? m.max
                                    : e.toValue(
                                          e.toPixels(m.max) + e.minPixelPadding
                                      )
                            );
                            if (!f.ordinal) {
                                d &&
                                ...
                                if (
                                    (e.series.length &&
                                        ...
                                        d) ||
                                    (e.panningState &&
                                        g >= e.panningState.startMin &&
                                        t <= e.panningState.startMax)
                                )
                                    e.setExtremes(g, t, !1, !1, {
                                        trigger: "pan"
                                    }),
                                        (c = !0);
                                b[h] = k;
            ...
            F(u.prototype, {
                            ...
                            d ||
                                f.getSelectedPoints().forEach(function(a) {
                                    ...
                                    a.selected &&
                                        ...
                                        (d.options.data[d.data.indexOf(a)] =
                                            a.options),
                                        a.setState(
                                            f.hoverPoints &&
                ...
                setState: function(a, d) {
                    ...
                    if (
                            ...
                            if (a && g) {
                                ...
                                if (v)
                                    if (m)
                                        ...
                                        e &&
                                            ((b.stateMarkerGraphic = m = l.renderer
                                                .symbol(
                                                    e,
                                                    v.x,
                                                    v.y,
                        ...
                        a = c.halo;
                        c =
                            ((m = this.graphic || m) && m.visibility) ||
                            "inherit";
                        a && a.size && m && "hidden" !== c && !this.isCluster
                            ? (r ||
                                  (b.halo = r = l.renderer
                                      .path()
                                      .add(m.parentGroup)),
                              r.show()[d ? "animate" : "attr"]({
                                  d: this.haloPath(a.size)
                              }),
                              r.attr({
                                  class:
                                      "highcharts-halo highcharts-color-" +
                                      n(this.colorIndex, b.colorIndex) +
                                      (this.className
                                          ? " " + this.className
                                          : ""),
                                  visibility: c,
            ...
            F(d.prototype, {
                ...
                setState: function(a, d) {
                    ...
                    if (
                        b.state !== a &&
                        ([b.group, b.markerGroup, b.dataLabelsGroup].forEach(
                            function(d) {
                                d &&
                                    (b.state &&
                                        d.removeClass(
                        ...
                        a &&
                            ((k =
                                h[a].lineWidth ||
                                k + (h[a].lineWidthPlus || 0)),
                            (g = n(h[a].opacity, g)));
                        if (f && !f.dashstyle)
                            for (
                                h = { "stroke-width": k }, f.animate(h, p);
                                b["zone-graph-" + e];

                            )
                                b["zone-graph-" + e].attr(h), (e += 1);
                        c ||
                            [
                                b.group,
                                b.markerGroup,
                ...
                setVisible: function(a, d) {
                    var b = this,
                        ...
                        h = b.visible;
                    var k = (b.visible = a = b.options.visible = b.userOptions.visible =
                    ...
                    if (
                        e.hoverSeries === b ||
                        (e.hoverPoint && e.hoverPoint.series) === b
                    )
                        b.onMouseOut();
    ...
    P(
        ...
        function(c, g) {
            ...
            c.prototype.setResponsive = function(c, g) {
                ...
                m = m.toString() || void 0;
                m !== (q && q.ruleIds) &&
                    (q && this.update(q.undoOptions, c, !0),
                    m
                        ? ((q = this.currentOptions(g)),
            ...
            c.prototype.matchResponsiveRule = function(c, g) {
                ...
                (
                    ...
                    function() {
                        return (
                            this.chartWidth <=
                                D(k.maxWidth, Number.MAX_VALUE) &&
                            this.chartHeight <=
                                D(k.maxHeight, Number.MAX_VALUE) &&
                            this.chartWidth >= D(k.minWidth, 0) &&
                            this.chartHeight >= D(k.minHeight, 0)
                        );
                    }
                ...
                function k(c, n, m, f) {
                    ...
                    N(c, function(d, c) {
                        if (!f && -1 < g.collectionsWithUpdate.indexOf(c))
                            for (d = F(d), m[c] = [], a = 0; a < d.length; a++)
                                n[c][a] &&
                                    ((m[c][a] = {}),
                                    k(d[a], n[c][a], m[c][a], f + 1));
                        else
                            y(d)
                                ? ((m[c] = q(d) ? [] : {}),
                                  k(d, n[c] || {}, m[c], f + 1))
        ...
        function(c, g) {
            ...
            u(c, "afterGetSeriesExtremes", function() {
                ...
                if (this.isXAxis) {
                    ...
                    this.series.forEach(function(v, y) {
                        v.useMapGeometry &&
                            ((u = Math.min(u, q(v.minX, u))),
                            (E = Math.max(E, q(v.maxX, E))),
                            (v.xData = c[y]),
                            (g = !0));
                    });
            ...
            u(c, "afterSetAxisTranslation", function() {
                ...
                if (
                    ...
                    (g.pixelPadding = g.len - c),
                    (g.minPixelPadding = g.pixelPadding / 2),
                    (c = g.fixTo))
                ) {
        ...
        c.colorSeriesMixin = {
            ...
            translateColors: function() {
                var c = this,
                    ...
                    q = this.colorAxis,
                    y = this.colorKey;
                (this.data.length ? this.data : this.points).forEach(function(
                    g
                ) {
    ...
    P(
        ...
        function(c, g, u, q, y, v) {
            ...
            v.prototype.collectionsWithInit.colorAxis = [
                v.prototype.addColorAxis
            ];
            ...
            F(f.prototype, {
                ...
                setTickPositions: function() {
                    if (!this.dataClasses)
                        return m.prototype.setTickPositions.call(this);
                },
                initStops: function() {
                ...
                buildOptions: function(a, d) {
                    var f = this.options.legend,
                        e = d.layout
                            ? "vertical" !== d.layout
                            : "vertical" !== f.layout;
                    return k(a, { side: e ? 2 : 1, reversed: !e }, d, {
                        opposite: !e,
                        showEmpty: !1,
                        title: null,
                ...
                setAxisSize: function() {
                    var a = this.legendSymbol,
                        ...
                        b;
                    a
                        ? ((this.left = f = a.attr("x")),
                          (this.top = e = a.attr("y")),
                          (this.width = b = a.attr("width")),
                          (this.height = a = a.attr("height")),
                          (this.right = d.chartWidth - f - b),
                          (this.bottom = d.chartHeight - e - a),
                          (this.len = this.horiz ? b : a),
                          (this.pos = this.horiz ? f : e))
                        : (this.len =
                ...
                getSeriesExtremes: function() {
                    ...
                    for (this.dataMax = -Infinity; d--; ) {
                        ...
                        k
                            ? ((e.minColorValue = e[b + "Min"]),
                              (e.maxColorValue = e[b + "Max"]))
                            : (L.prototype.getExtremes.call(e, g),
                              (e.minColorValue = e.dataMin),
                              (e.maxColorValue = e.dataMax));
                ...
                drawCrosshair: function(a, d) {
                    ...
                    if (d) {
                        var k = this.toPixels(
                            d.getNestedProperty(d.series.colorKey)
                        );
                ...
                getPlotLinePath: function(a) {
                    ...
                    return C(d)
                        ...
                        : m.prototype.getPlotLinePath.apply(this, arguments);
                },
                update: function(a, d) {
                    var f = this.chart,
                        e = f.legend,
                    ...
                    ((a.dataClasses && e.allItems) || this.dataClasses) &&
                        this.destroyItems();
                    f.options[this.coll] = k(this.userOptions, b);
                    m.prototype.update.call(this, b, d);
                    this.legendItem &&
                        (this.setLegendColor(), e.colorizeItem(this, !0));
                },
                ...
                getDataClassLegendSymbols: function() {
                    var a = this,
                        ...
                        k;
                    f.length ||
                        this.dataClasses.forEach(function(e, h) {
                            var g = !0,
                                n = e.from,
                                m = e.to,
                                p = d.numberFormatter;
            ...
            g(v, "afterGetAxes", function() {
                ...
                d.colorAxis &&
                    ...
                    d.colorAxis.forEach(function(d, e) {
                        d.index = e;
                        new f(a, d);
                    }));
            });
                ...
                (this.chart.colorAxis || []).forEach(function(b) {
                    (f = b.options) &&
                        ...
                        (f.dataClasses && f.visible
                            ? (d = d.concat(b.getDataClassLegendSymbols()))
                            : f.visible && d.push(b),
                        b.series.forEach(function(b) {
                            if (!b.options.showInLegend || f.dataClasses)
                                "point" === b.options.legendType
    ...
    P(
        ...
        [u["parts/Globals.js"], u["parts/Point.js"], u["parts/Utilities.js"]],
        function(c, g, u) {
            var q = u.defined;
            u = c.noop;
            var y = c.seriesTypes;
            c.colorMapPointMixin = {
                ...
                setState: function(c) {
                    ...
                    this.graphic &&
                        this.graphic.attr({ zIndex: "hover" === c ? 1 : 0 });
                }
            };
        ...
        function(c, g) {
            ...
            q.prototype.update = function(c) {
                var k = this.chart,
                    ...
                    d = k.mapNavButtons;
                c &&
                    (g = k.options.mapNavigation = N(
                        k.options.mapNavigation,
                        c
                    ));
                for (; d.length; ) d.pop().destroy();
                F(g.enableButtons, g.enabled) &&
                    !k.renderer.forExport &&
                    D(g.buttons, function(c, e) {
                        m = N(g.buttonOptions, c);
                        k.styledMode ||
                            ((q = m.theme),
                            (q.style = N(m.theme.style, m.style)),
                            (C = (n = q.states) && n.hover),
                            (f = n && n.select));
                        c = k.renderer
                            .button(
                                m.text,
                                ...
                                f,
                                0,
                                "zoomIn" === e ? "topbutton" : "bottombutton"
                            )
                            .addClass(
            ...
            q.prototype.updateEvents = function(c) {
                var k = this.chart;
                F(c.enableDoubleClickZoom, c.enabled) ||
                c.enableDoubleClickZoomTo
                    ? (this.unbindDblClick =
                          this.unbindDblClick ||
                          y(k.container, "dblclick", function(c) {
                              k.pointer.onContainerDblClick(c);
                          }))
                    : this.unbindDblClick &&
                      (this.unbindDblClick = this.unbindDblClick());
                F(c.enableMouseWheelZoom, c.enabled)
                    ? (this.unbindMouseWheel =
                          this.unbindMouseWheel ||
                          y(
                              k.container,
                              "undefined" === typeof C.onmousewheel
                                  ? "DOMMouseScroll"
                                  : "mousewheel",
                              function(c) {
            ...
            v(g.prototype, {
                ...
                mapZoom: function(c, g, q, m, v) {
                    ...
                    f = this.fitToBox(
                        {
                            x: f - a * (m ? (m - k.pos) / k.len : 0.5),
                            y: h - d * (v ? (v - r.pos) / r.len : 0.5),
                            width: a,
                            height: d
                        },
                        {
                    ...
                    a =
                        f.x <= k.dataMin &&
                        f.width >= k.dataMax - k.dataMin &&
                        f.y <= r.dataMin &&
                        f.height >= r.dataMax - r.dataMin;
                    m && (k.fixTo = [m - k.pos, g]);
                    v && (r.fixTo = [v - r.pos, q]);
                    "undefined" === typeof c || a
                        ? (k.setExtremes(void 0, void 0, !1),
                          r.setExtremes(void 0, void 0, !1))
                        : (k.setExtremes(f.x, f.x + f.width, !1),
                          r.setExtremes(f.y, f.y + f.height, !1));
                    this.redraw();
                }
            });
            ...
            u(c.prototype, {
                ...
                onContainerMouseWheel: function(c) {
                    ...
                    g.isInsidePlot(
                        ...
                        g.mapZoom(
                            Math.pow(
                                g.options.mapNavigation.mouseWheelSensitivity,
                                q
                            ),
                            g.xAxis[0].toValue(c.chartX),
                            g.yAxis[0].toValue(c.chartY),
            ...
            x(
                ...
                C(c.colorMapSeriesMixin, {
                    ...
                    getBox: function(a) {
                        ...
                        q &&
                            ((this.minY = Math.min(k, r(this.minY, d))),
                            (this.maxY = Math.max(b, r(this.maxY, -d))),
                            (this.minX = Math.min(e, r(this.minX, d))),
                            (this.maxX = Math.max(f, r(this.maxX, -d))),
                            n &&
                                "undefined" === typeof n.options.minRange &&
                                (n.minRange = Math.min(
                                    5 * g,
                            ...
                            m &&
                                "undefined" === typeof m.options.minRange &&
                                (m.minRange = Math.min(
                                    5 * g,
                    ...
                    setData: function(a, d, f, e) {
                            ...
                            a.forEach(function(d, c) {
                                ...
                                if (F(d)) a[c] = { value: d };
                                    ...
                                    !b.keys &&
                                        ...
                                        "string" === typeof d[0] &&
                                        ((a[c]["hc-key"] = d[0]), ++e);
                                    for (var f = 0; f < q.length; ++f, ++e)
                                        q[f] &&
                                            "undefined" !== typeof d[e] &&
                                            (0 < q[f].indexOf(".")
                                                ? u.prototype.setNestedProperty(
                                                      a[c],
                                                      d[e],
                                                      q[f]
                                                  )
                        ...
                        if (n) {
                            "FeatureCollection" === n.type &&
                                ((this.mapTitle = n.title),
                                (n = c.geojson(n, this.type, this)));
                            this.mapData = n;
                            this.mapMap = {};
                    ...
                    translate: function() {
                        ...
                        a.data.forEach(function(b) {
                            ...
                            e &&
                                ((b.shapeType = "path"),
                                (b.shapeArgs = { d: a.translatePath(b.path) }));
                        });
                        v(a, "afterTranslate");
                    },
                    pointAttribs: function(a, d) {
                        d = a.series.chart.styledMode
                            ? this.colorAttribs(a)
                            : f.column.prototype.pointAttribs.call(this, a, d);
                        d["stroke-width"] = r(
                            a.options[
                        ...
                        if (a.doFullTranslate())
                            b.hasRendered &&
                                ...
                                a.points.forEach(function(b) {
                                    b.shapeArgs &&
                                        (b.shapeArgs.fill = a.pointAttribs(
                                            b,
                                            b.state
                                        ).fill);
                                }),
                                (a.group = a.transformGroup),
                                f.column.prototype.drawPoints.apply(a),
                                (a.group = e),
                                ...
                                (this.baseTrans = {
                                    originX:
                                        d.min - d.minPixelPadding / d.transA,
                                    originY:
                                        c.min -
                ...
                y(
                    {
                        applyOptions: function(a, d) {
                            var c = this.series;
                            a = u.prototype.applyOptions.call(this, a, d);
                            d = c.joinBy;
                            c.mapData &&
                                c.mapMap &&
                                ((d = u.prototype.getNestedProperty.call(
                                    a,
                                    d[1]
                                )),
                                (d = "undefined" !== typeof d && c.mapMap[d])
                                    ? (c.xyFromShape &&
                                          ((a.x = d._midX), (a.y = d._midY)),
                                      y(a, d))
        ...
        function(c, g, u, q) {
                ...
                c.prototype.drawLegendSymbol = function(a) {
                    ...
                    b && b.length && D(b[0].value)
                        ? (r(b, function(a, b) {
                          ...
                          (f = 0 < f ? f : 0),
                          (this.maxLabel = d),
                          (this.movementX = "left" === c.labels.align ? f : 0),
                ...
                c.prototype.renderRange = function(a) {
                    ...
                    b.bubbleItems.push(
                        e
                            .circle(
                                u,
                                g + ((v % 1 ? 1 : 0.5) - (f % 2 ? 0 : 0.5)),
                                n
                            )
                            .attr(x ? {} : a.bubbleStyle)
                            .addClass(
                                (x
                                    ? "highcharts-color-" +
                                      this.options.seriesIndex +
                    ...
                    a.chart.series.forEach(function(a) {
                        a.isBubble &&
                            ...
                            f.length &&
                                ...
                                (b = k(a.options.zMax, Math.max(b, v(f))))));
                    });
                    var g =
                        e === b
                            ? [{ value: b }]
            ...
            g(u, "afterGetAllItems", function(f) {
                ...
                0 <= e &&
                    ...
                    h.enabled &&
                    ((h.seriesIndex = e),
                    (this.bubbleLegend = new c.BubbleLegend(h, this)),
                    this.bubbleLegend.addToLegend(f.allItems));
            });
            ...
            u.prototype.getLinesHeights = function() {
                ...
                for (h = 0; h < d; h++)
                    if (
                        (c[h].legendItemHeight &&
                            (c[h].itemHeight = c[h].legendItemHeight),
                        c[h] === c[d - 1] ||
                            (c[h + 1] &&
                                c[h]._legendItemPos[1] !==
                                    c[h + 1]._legendItemPos[1]))
                    ) {
                        a.push({ height: 0 });
                        var b = a[a.length - 1];
                        for (e; e <= h; e++)
                            c[e].itemHeight > b.height &&
                                (b.height = c[e].itemHeight);
                        b.step = h;
                    }
                return a;
            };
            u.prototype.retranslateItems = function(c) {
                ...
                this.allItems.forEach(function(h, k) {
                    ...
                    if ((f = h.movementX) || (e && h.ranges))
                        (f = e ? a - h.options.maxSize / 2 : a + f),
                            h.legendGroup.attr({ translateX: f });
                    k > c[b].step && b++;
                    h.legendGroup.attr({
    ...
    P(
        ...
        function(c, g, u, q) {
            ...
            g(
                ...
                {
                    haloPath: function(c) {
                        return u.prototype.haloPath.call(
                            this,
                            0 === c
                                ? 0
            ...
            q.prototype.beforePadding = function() {
                ...
                F.length &&
                    ...
                    !this.isLog &&
                    ((d -= g),
                    (y *= (g + Math.max(0, a) - Math.min(d, g)) / g),
                    [
                        ["min", "userMin", a],
                        ["max", "userMax", d]
                    ].forEach(function(a) {
                        "undefined" === typeof k(c.options[a[0]], c[a[1]]) &&
                            (c[a[0]] += a[2] / y);
                    }));
            };
            ("");
                    ...
                    },
                    {
                        applyOptions: function(c, u) {
                            return c &&
                                ...
                                : y.map.prototype.pointClass.prototype.applyOptions.call(
                                      this,
                                      c,
                                      u
                                  );
    ...
    P(
        ...
        function(c, g) {
            ...
            D.prototype.transformFromLatLon = function(c, k) {
                var g,
                    u =
                        (null === (g = this.userOptions.chart) || void 0 === g
                            ? void 0
                            : g.proj4) || F.proj4;
                if (!u) return q(21, !1, this), { x: 0, y: null };
                c = u(k.crs, [c.lon, c.lat]);
                g = k.cosAngle || (k.rotation && Math.cos(k.rotation));
                u = k.sinAngle || (k.rotation && Math.sin(k.rotation));
                c = k.rotation
                    ? [c[0] * g + c[1] * u, -c[0] * u + c[1] * g]
                    : c;
                return {
                    x:
                        ((c[0] - (k.xoffset || 0)) * (k.scale || 1) +
                            (k.xpan || 0)) *
                            (k.jsonres || 1) +
                        (k.jsonmarginX || 0),
                    y:
                        (((k.yoffset || 0) - c[1]) * (k.scale || 1) +
                            (k.ypan || 0)) *
                            (k.jsonres || 1) -
                        (k.jsonmarginY || 0)
                };
            ...
            D.prototype.transformToLatLon = function(c, k) {
                if ("undefined" === typeof F.proj4) q(21, !1, this);
                    ...
                    c = {
                        x:
                            ((c.x - (k.jsonmarginX || 0)) / (k.jsonres || 1) -
                                (k.xpan || 0)) /
                                (k.scale || 1) +
                            (k.xoffset || 0),
                        y:
                            ((-c.y - (k.jsonmarginY || 0)) / (k.jsonres || 1) +
                                (k.ypan || 0)) /
                                (k.scale || 1) +
                            (k.yoffset || 0)
                    };
            ...
            D.prototype.fromPointToLatLon = function(c) {
                ...
                if (k) {
                    for (g in k)
                        if (
                            Object.hasOwnProperty.call(k, g) &&
                            k[g].hitZone &&
                            u({ x: c.x, y: -c.y }, k[g].hitZone.coordinates[0])
                        )
                            return this.transformToLatLon(c, k[g]);
                    return this.transformToLatLon(c, k["default"]);
                }
                q(22, !1, this);
            };
            D.prototype.fromLatLonToPoint = function(c) {
                var k = this.mapTransforms,
                    g;
                if (!k) return q(22, !1, this), { x: 0, y: null };
                for (g in k)
                    if (Object.hasOwnProperty.call(k, g) && k[g].hitZone) {
                        var v = this.transformFromLatLon(c, k[g]);
                        if (u({ x: v.x, y: -v.y }, k[g].hitZone.coordinates[0]))
                            return v;
                    }
            ...
            c.geojson = function(c, g, q) {
                var k = [],
                    ...
                    r = function(c) {
                        ...
                        m.push("M");
                        for (g = 0; g < f; g++)
                            1 === g && m.push("L"), m.push(c[g][0], -c[g][1]);
                    };
                g = g || "map";
                c.features.forEach(function(c) {
                    ...
                    "map" === g || "mapbubble" === g
                        ...
                        ? ("LineString" === f
                              ? r(n)
                              : "MultiLineString" === f && n.forEach(r),
                          m.length && (a = { path: m }))
                        : "mappoint" === g &&
                          "Point" === f &&
                          (a = { x: n[0], y: -n[1] });
                    a &&
                        k.push(y(a, { name: c.name || c.NAME, properties: c }));
                });
                q &&
                    c.copyrightShort &&
                    ((q.chart.mapCredits = v(q.chart.options.credits.mapText, {
                        geojson: c
                    })),
                    (q.chart.mapCreditsFull = v(
                        q.chart.options.credits.mapTextFull,
                        { geojson: c }
                    )));
                return k;
            };
    ...
    P(
        ...
        function(c, g) {
            ...
            var D = c.Renderer,
                F = c.SVGRenderer,
                C = c.VMLRenderer;
            q(g.lang, { zoomIn: "Zoom in", zoomOut: "Zoom out" });
            g.mapNavigation = {
                buttonOptions: {
                    alignTo: "plotBox",
                    align: "left",
            ...
            c.splitPath = function(c) {
                ...
                for (g = 0; g < c.length; g++)
                    /[a-zA-Z]/.test(c[g]) || (c[g] = parseFloat(c[g]));
                return c;
            };
            c.maps = {};
    ...
    P(u, "masters/highmaps.src.js", [u["masters/highcharts.src.js"]], function(
        c
    ) {
        c.product = "Highmaps";
        return c;
