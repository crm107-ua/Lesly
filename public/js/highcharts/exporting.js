...
(function(e) {
        ...
        var g = f.addEvent,
            ...
            n = (function() {
                function g(h) {
                    this.chart = h;
                    this.isOpen = !1;
                    h.container.parentNode instanceof Element &&
                        ((h = h.container.parentNode),
                        this.browserProps ||
                            ("function" === typeof h.requestFullscreen
                                ? (this.browserProps = {
                ...
                g.prototype.close = function() {
                    ...
                    if (
                        this.isOpen &&
                        this.browserProps &&
                        h.container.ownerDocument instanceof Document
                    )
                ...
                g.prototype.open = function() {
                    var h = this,
                        g = h.chart;
                    if (h.browserProps) {
                        h.unbindFullscreenEvent = f.addEvent(
                            g.container.ownerDocument,
                            h.browserProps.fullscreenChange,
                            function() {
                                h.isOpen
                                    ? ((h.isOpen = !1), h.close())
                                    : ((h.isOpen = !0), h.setButtonText());
                            }
                        );
                        if (g.container.parentNode instanceof Element) {
                            var e = g.container.parentNode[
                                h.browserProps.requestFullscreen
                            ]();
                            if (e)
                                e["catch"](function() {
                                    alert(
                            ...
                            null ===
                                (h =
                                    null === e || void 0 === e
                                        ...
                                        : e.buttons) || void 0 === h
                                ? void 0
                                : h.contextButton.menuItems;
                    h = g.options.lang;
                    (null === e || void 0 === e ? 0 : e.menuItemDefinitions) &&
                        (null === h || void 0 === h ? 0 : h.exitFullscreen) &&
                        h.viewFullscreen &&
                        n &&
                        f &&
                        f.length &&
                        (f[n.indexOf("viewFullscreen")].innerHTML = this.isOpen
                            ? h.exitFullscreen
                            : e.menuItemDefinitions.viewFullscreen.text ||
                              h.viewFullscreen);
                };
    ...
    m(
        ...
        function(f, g, e) {
            ...
            f.isSafari &&
                f.win.matchMedia("print").addListener(function(a) {
                    f.printingChart &&
                        (a.matches
                            ? f.printingChart.beforePrint()
                            : f.printingChart.afterPrint());
                });
            x(C.prototype, {
                ...
                getSVGForExport: function(a, b) {
                    ...
                    return this.getSVG(
                        p({ chart: { borderRadius: 0 } }, c.chartOptions, b, {
                            exporting: {
                                sourceWidth:
                                    (a && a.sourceWidth) || c.sourceWidth,
                                sourceHeight:
                                    (a && a.sourceHeight) || c.sourceHeight
                            }
                        })
                    );
                },
                ...
                contextMenu: function(a, b, c, d, e, f, r) {
                    ...
                    if (!l) {
                        ...
                        b.forEach(function(a) {
                            "string" === typeof a &&
                                (a =
                                    k.options.exporting.menuItemDefinitions[a]);
                            if (J(a, !0)) {
                    ...
                    b = { display: "block" };
                    c + k.exportMenuWidth > p
                        ? (b.right = p - c - e - v + "px")
                        : (b.left = c - v + "px");
                    d + f + k.exportMenuHeight > A &&
                    "top" !== r.alignOptions.verticalAlign
                        ? (b.bottom = A - d - v + "px")
                        : (b.top = d + f - v + "px");
                    u(l, b);
                ...
                addButton: function(a) {
                    ...
                    if (!1 !== d.enabled) {
                        ...
                        var A;
                        b.styledMode ||
                            ((k.fill = q(k.fill, "#ffffff")),
                            (k.stroke = q(k.stroke, "none")));
                        delete k.states;
                        g
                            ? (A = function(a) {
                                  a && a.stopPropagation();
                        ...
                        d.text && d.symbol
                            ? (k.paddingLeft = q(k.paddingLeft, 25))
                            : d.text ||
                              x(k, {
                                  width: d.width,
                                  height: d.height,
                        ...
                        t.add(b.exportingGroup).align(
                            x(d, { width: t.width, x: q(d.x, b.buttonOffset) }),
                            !0,
                            "spacingBox"
                        );
                        b.buttonOffset +=
                            (t.width + d.buttonSpacing) *
                            ("right" === d.align ? -1 : 1);
            ...
            C.prototype.inlineStyles = function() {
                ...
                function b(c) {
                    function k(b, e) {
                        ...
                        for (q = f.length; q-- && !v; )
                            v = f[q].test(e) || "function" === typeof b;
                        v ||
                            (x[e] === b && "svg" !== c.nodeName) ||
                            h[c.nodeName][e] === b ||
                            (-1 !== d.indexOf(e)
                                ? c.setAttribute(a(e), b)
                                : (l += a(e) + ":" + b + ";"));
                    }
                    var l = "",
                        v,
