<div class="row row-sm">
    <?php $__currentLoopData = $explorer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
        ...
        <div class="pos-rlt">
            ...
            <div class="center text-center m-t-n">
                <a href="/song/<?php echo e($item->artist->username); ?>/<?php echo e($item->slug); ?>"><i class="icon-control-play i-2x"></i></a>
            </div>
...
</div><?php /**PATH C:\Users\carom\Desktop\proyectos\Lesly\resources\views/pages/dashboard/first_content.blade.php ENDPATH**/ ?>