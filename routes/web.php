...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Elimina esta línea si `Auth::routes()` ya define `logout`
    ...
    Route::post('/add-playlist', 'PlaylistController@store')->name('add-playlist-post');

    Route::get('/mod-playlist/{playlist_slug}', 'PlaylistController@edit')->name('mod-playlist');
    Route::post('/mod-playlist', 'PlaylistController@update')->name('mod-playlist-post');
